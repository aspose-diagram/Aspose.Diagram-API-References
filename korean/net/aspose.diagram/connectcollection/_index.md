...
description: 컬렉션을 연결합니다.
type: docs
weight: 910
url: /ko/net/aspose.diagram/connectcollection/
---
...
| [Item](../../aspose.diagram/connectcollection/item/) { get; } | 지정된 인덱스에서 요소를 가져옵니다. |

## 행동 양식

| 이름 | 설명 |
| --- | --- |
| [Add](../../aspose.diagram/connectcollection/add/)(Connect) | 컬렉션에 연결을 추가합니다. |
...
| [Remove](../../aspose.diagram/connectcollection/remove/)(Connect) | 컬렉션에서 연결을 제거합니다. |
