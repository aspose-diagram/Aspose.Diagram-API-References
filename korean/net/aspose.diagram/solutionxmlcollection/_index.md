...
type: docs
weight: 3820
url: /ko/net/aspose.diagram/solutionxmlcollection/
---
...
| [Item](../../aspose.diagram/solutionxmlcollection/item/) { get; } | 지정된 인덱스에 있는 요소를 가져옵니다. (2 indexers) |

## 행동 양식

| 이름 | 설명 |
| --- | --- |
| [Add](../../aspose.diagram/solutionxmlcollection/add/)(SolutionXML) | 컬렉션에 SolutionXML을 추가합니다. |
...
| [Remove](../../aspose.diagram/solutionxmlcollection/remove/)(SolutionXML) | 컬렉션에서 SolutionXML을 제거합니다. |
