...
description: 스타일시트 모음.
type: docs
weight: 3930
url: /ko/net/aspose.diagram/stylesheetcollection/
---
...
| [Item](../../aspose.diagram/stylesheetcollection/item/) { get; } | 지정된 인덱스에 있는 요소를 가져옵니다. |

## 행동 양식

| 이름 | 설명 |
| --- | --- |
| [Add](../../aspose.diagram/stylesheetcollection/add/)(StyleSheet) | 컬렉션에 StyleSheet를 추가합니다. |
...
| [GetStyleSheet](../../aspose.diagram/stylesheetcollection/getstylesheet/)(int) | 지정된 ID의 요소를 가져옵니다. |
| [IsExist](../../aspose.diagram/collection/isexist/)(int) | 컬렉션에 있는 항목입니다. |
| [Remove](../../aspose.diagram/stylesheetcollection/remove/)(StyleSheet) | 컬렉션에서 StyleSheet를 제거합니다. |
