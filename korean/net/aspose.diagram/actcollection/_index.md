...
type: docs
weight: 30
url: /ko/net/aspose.diagram/actcollection/
---
## ActCollection class
...
| [Item](../../aspose.diagram/actcollection/item/) { get; } | 지정된 인덱스에서 요소를 가져옵니다. |

## 행동 양식

| 이름 | 설명 |
| --- | --- |
| [Add](../../aspose.diagram/actcollection/add/)(Act) | 컬렉션에 Act 개체를 추가합니다. |
| [Clear](../../aspose.diagram/collection/clear/)() | 컬렉션에서 모든 요소를 제거합니다. |
| [GetAct](../../aspose.diagram/actcollection/getact/)(int) | 지정된 ID의 요소를 가져옵니다. |
...
| [Remove](../../aspose.diagram/actcollection/remove/)(Act) | 컬렉션에서 Act 개체를 제거합니다. |
