...
description: 더블링 포인트 숫자 모음을 포함합니다
type: docs
weight: 1530
url: /ko/net/aspose.diagram/floatpointnumcollection/
---
## FloatPointNumCollection class

더블링 포인트 숫자 모음을 포함합니다
...
| [Item](../../aspose.diagram/floatpointnumcollection/item/) { get; } | 지정된 인덱스에 있는 요소를 가져옵니다. |

## 행동 양식

| 이름 | 설명 |
| --- | --- |
| [Add](../../aspose.diagram/floatpointnumcollection/add/)(double) | 컬렉션에 더블링 포인트 번호를 추가합니다. |
...
| [Remove](../../aspose.diagram/floatpointnumcollection/remove/)(double) | 컬렉션에서 더블링 포인트 번호를 제거합니다. |
