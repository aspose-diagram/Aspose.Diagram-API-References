...
type: docs
weight: 2860
url: /ko/net/aspose.diagram/propcollection/
---
...
| [Item](../../aspose.diagram/propcollection/item/) { get; } | 지정된 인덱스에서 요소를 가져옵니다. |

## 행동 양식

| 이름 | 설명 |
| --- | --- |
| [Add](../../aspose.diagram/propcollection/add/)(Prop) | 컬렉션에 소품 개체를 추가합니다. |
...
| [GetProp](../../aspose.diagram/propcollection/getprop/#getprop)(int) | 지정된 ID의 요소를 가져옵니다. |
| [GetProp](../../aspose.diagram/propcollection/getprop/#getprop_1)(string) | 지정된 이름의 요소를 가져옵니다. |
| [IsExist](../../aspose.diagram/collection/isexist/)(int) | 컬렉션에 있는 항목입니다. |
| [Remove](../../aspose.diagram/propcollection/remove/)(Prop) | 컬렉션에서 소품 개체를 제거합니다. |
