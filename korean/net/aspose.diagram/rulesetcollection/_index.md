...
description: 규칙 세트 컬렉션.
type: docs
weight: 3160
url: /ko/net/aspose.diagram/rulesetcollection/
---
...
| [Item](../../aspose.diagram/rulesetcollection/item/) { get; } | 지정된 인덱스에 있는 요소를 가져옵니다. |

## 행동 양식

| 이름 | 설명 |
| --- | --- |
| [Add](../../aspose.diagram/rulesetcollection/add/)(RuleSet) | 컬렉션에 규칙 집합을 추가합니다. |
...
| [Remove](../../aspose.diagram/rulesetcollection/remove/)(RuleSet) | 컬렉션에서 규칙 집합을 제거합니다. |
