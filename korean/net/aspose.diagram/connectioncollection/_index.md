...
type: docs
weight: 960
url: /ko/net/aspose.diagram/connectioncollection/
---
...
| [Item](../../aspose.diagram/connectioncollection/item/) { get; } | 지정된 인덱스에서 요소를 가져옵니다. |

## 행동 양식

| 이름 | 설명 |
| --- | --- |
| [Add](../../aspose.diagram/connectioncollection/add/)(Connection) | 컬렉션에 연결 개체를 추가합니다. |
...
| [Remove](../../aspose.diagram/connectioncollection/remove/)(Connection) | 컬렉션에서 연결 개체를 제거합니다. |
