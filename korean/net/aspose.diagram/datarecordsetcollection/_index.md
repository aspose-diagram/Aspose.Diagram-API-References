...
description: DataRecordSet 컬렉션.
type: docs
weight: 1150
url: /ko/net/aspose.diagram/datarecordsetcollection/
---
...
| [Item](../../aspose.diagram/datarecordsetcollection/item/) { get; } | 지정된 인덱스에 있는 요소를 가져옵니다. |
| [NextId](../../aspose.diagram/datarecordsetcollection/nextid/) { get; set; } | 다음ID |

## 행동 양식

| 이름 | 설명 |
| --- | --- |
| [Add](../../aspose.diagram/datarecordsetcollection/add/)(DataRecordSet) | 컬렉션에 dataRecordSet를 추가합니다. |
...
| [Remove](../../aspose.diagram/datarecordsetcollection/remove/)(DataRecordSet) | 컬렉션에서 dataRecordSet을 제거합니다. |
