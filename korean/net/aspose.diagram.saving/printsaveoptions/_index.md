...
type: docs
weight: 3440
url: /ko/net/aspose.diagram.saving/printsaveoptions/
---
...
| 이름 | 설명 |
| --- | --- |
| [PrintSaveOptions](printsaveoptions/)() | 이 class 의 새 인스턴스를 초기화합니다. |
...
| [PageCount](../../aspose.diagram.saving/printsaveoptions/pagecount/) { get; set; } | 다중 페이지 파일로 저장할 때 렌더링할 페이지 수를 가져오거나 설정합니다. 기본값은 다이어그램의 모든 페이지가 인쇄됨을 의미하는 MaxValue입니다. |
...
| [SaveForegroundPagesOnly](../../aspose.diagram.saving/printsaveoptions/saveforegroundpagesonly/) { get; set; } | 모든 페이지를 인쇄할지 전경만 인쇄할지 지정합니다. |
