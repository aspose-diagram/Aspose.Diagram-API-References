...
description: Bevat elementen die informatie over een elliptische boog specificeren. Coördinaten worden opgegeven als relatieve coördinaten.
type: docs
weight: 318
url: /nl/java/com.aspose.diagram/relellipticalarcto/
---
...
| --- | --- |
| [RelEllipticalArcTo()](#RelEllipticalArcTo--) | Maakt een instantie van de klasse [EllipticalArcTo](../../com.aspose.diagram/ellipticalarcto) aan. |
## Methoden
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setA(DoubleValue value)](#setA-com.aspose.diagram.DoubleValue-) | Voor de beschrijving van deze eigenschap, zie [getA()](../../com.aspose.diagram/relellipticalarcto\#getA--) |
| [setB(DoubleValue value)](#setB-com.aspose.diagram.DoubleValue-) | Voor de beschrijving van deze eigenschap, zie [getB()](../../com.aspose.diagram/relellipticalarcto\#getB--) |
| [setC(DoubleValue value)](#setC-com.aspose.diagram.DoubleValue-) | Voor de beschrijving van deze eigenschap, zie [getC()](../../com.aspose.diagram/relellipticalarcto\#getC--) |
| [setD(DoubleValue value)](#setD-com.aspose.diagram.DoubleValue-) | Voor de beschrijving van deze eigenschap, zie [getD()](../../com.aspose.diagram/relellipticalarcto\#getD--) |
| [setDel(int value)](#setDel-int-) | Voor de beschrijving van deze eigenschap, zie [getDel()](../../com.aspose.diagram/relellipticalarcto\#getDel--) |
| [setIX(int value)](#setIX-int-) | Voor de beschrijving van deze eigenschap, zie [getIX()](../../com.aspose.diagram/relellipticalarcto\#getIX--) |
| [setX(DoubleValue value)](#setX-com.aspose.diagram.DoubleValue-) | Voor de beschrijving van deze eigenschap, zie [getX()](../../com.aspose.diagram/relellipticalarcto\#getX--) |
| [setY(DoubleValue value)](#setY-com.aspose.diagram.DoubleValue-) | Voor de beschrijving van deze eigenschap, zie [getY()](../../com.aspose.diagram/relellipticalarcto\#getY--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Voor de beschrijving van deze eigenschap, zie [getA()](../../com.aspose.diagram/relellipticalarcto\#getA--)
...
Voor de beschrijving van deze eigenschap, zie [getB()](../../com.aspose.diagram/relellipticalarcto\#getB--)
...
Voor de beschrijving van deze eigenschap, zie [getC()](../../com.aspose.diagram/relellipticalarcto\#getC--)
...
Voor de beschrijving van deze eigenschap, zie [getD()](../../com.aspose.diagram/relellipticalarcto\#getD--)
...
Voor de beschrijving van deze eigenschap, zie [getDel()](../../com.aspose.diagram/relellipticalarcto\#getDel--)
...
Voor de beschrijving van deze eigenschap, zie [getIX()](../../com.aspose.diagram/relellipticalarcto\#getIX--)
...
Voor de beschrijving van deze eigenschap, zie [getX()](../../com.aspose.diagram/relellipticalarcto\#getX--)
...
Voor de beschrijving van deze eigenschap, zie [getY()](../../com.aspose.diagram/relellipticalarcto\#getY--)
