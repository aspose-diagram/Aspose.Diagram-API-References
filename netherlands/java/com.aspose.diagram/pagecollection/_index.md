...
description: Paginasamenstelling.
type: docs
weight: 261
url: /nl/java/com.aspose.diagram/pagecollection/
---
...
| --- | --- |
| [add(Page page)](#add-com.aspose.diagram.Page-) | Voeg de pagina toe aan de collectie. |
...
| [getPage(int ID)](#getPage-int-) | Haalt het element op bij de opgegeven ID. |
| [getPage(String name)](#getPage-java.lang.String-) | Haalt het element op bij de opgegeven naam. |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Page page)](#remove-com.aspose.diagram.Page-) | Verwijder de pagina uit de collectie. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
