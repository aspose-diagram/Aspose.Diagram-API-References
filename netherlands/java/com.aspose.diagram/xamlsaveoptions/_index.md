...
description: Staat toe om extra opties op te geven bij het renderen van diagrampagina's naar XAML.
type: docs
weight: 448
url: /nl/java/com.aspose.diagram/xamlsaveoptions/
---
...
Staat toe om extra opties op te geven bij het renderen van diagrampagina's naar XAML.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [XAMLSaveOptions()](#XAMLSaveOptions--) | Initialiseert een nieuw exemplaar van deze klasse dat kan worden gebruikt om een document op te slaan in het Aspose.Diagram.SaveFileFormat-formaat. |
## Methoden
...
| [getPageCount()](#getPageCount--) | het aantal pagina's om te renderen in XAML. |
...
| [setPageCount(int value)](#setPageCount-int-) | Voor de beschrijving van deze eigenschap, zie [getPageCount()](../../com.aspose.diagram/xamlsaveoptions\#getPageCount--) |
| [setPageIndex(int value)](#setPageIndex-int-) | Voor de beschrijving van deze eigenschap, zie [getPageIndex()](../../com.aspose.diagram/xamlsaveoptions\#getPageIndex--) |
| [setSaveForegroundPagesOnly(boolean value)](#setSaveForegroundPagesOnly-boolean-) | Voor de beschrijving van deze eigenschap, zie [getSaveForegroundPagesOnly()](../../com.aspose.diagram/xamlsaveoptions\#getSaveForegroundPagesOnly--) |
| [setSaveFormat(int value)](#setSaveFormat-int-) | Voor de beschrijving van deze eigenschap, zie [getSaveFormat()](../../com.aspose.diagram/xamlsaveoptions\#getSaveFormat--) |
| [setStreamProvider(IStreamProvider value)](#setStreamProvider-com.aspose.diagram.IStreamProvider-) | Voor de beschrijving van deze eigenschap, zie [getStreamProvider()](../../com.aspose.diagram/xamlsaveoptions\#getStreamProvider--) |
...
Het aantal pagina's dat in XAML moet worden gerenderd. Standaard is MaxValue, wat betekent dat alle pagina's van het diagram worden gerenderd.
...
Voor de beschrijving van deze eigenschap, zie [getPageCount()](../../com.aspose.diagram/xamlsaveoptions\#getPageCount--)
...
Voor de beschrijving van deze eigenschap, zie [getPageIndex()](../../com.aspose.diagram/xamlsaveoptions\#getPageIndex--)
...
Voor de beschrijving van deze eigenschap, zie [getSaveForegroundPagesOnly()](../../com.aspose.diagram/xamlsaveoptions\#getSaveForegroundPagesOnly--)
...
Voor de beschrijving van deze eigenschap, zie [getSaveFormat()](../../com.aspose.diagram/xamlsaveoptions\#getSaveFormat--)
...
Voor de beschrijving van deze eigenschap, zie [getStreamProvider()](../../com.aspose.diagram/xamlsaveoptions\#getStreamProvider--)
