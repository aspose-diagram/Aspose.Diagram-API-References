...
description: Onbekende besturingselement.
type: docs
weight: 424
url: /nl/java/com.aspose.diagram/unknowncontrol/
---
...
| [getPersistenceType()](#getPersistenceType--) | Haalt de persistentiemethode op om een ActiveX-besturingselement op te slaan. |
| [getRelationshipData(String relId)](#getRelationshipData-java.lang.String-) | Haalt de relatiegegevens op. |
...
Haalt de persistentiemethode op om een ActiveX-besturingselement op te slaan.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| relId | java.lang.String | De relatie-id. |

**Returns:**
byte[] - retourneert de relatiegegevens.
### getType() {#getType--}
```
public int getType()
```
