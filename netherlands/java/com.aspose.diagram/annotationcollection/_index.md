...
description: Annotatie-collectie.
type: docs
weight: 21
url: /nl/java/com.aspose.diagram/annotationcollection/
---
...
| --- | --- |
| [add(Annotation item)](#add-com.aspose.diagram.Annotation-) | Voeg het Annotation‑object toe aan de collectie. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Annotation item)](#remove-com.aspose.diagram.Annotation-) | Verwijder het Annotation‑object uit de collectie. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Verwijder het Annotation‑object uit de collectie.
