...
type: docs
weight: 402
url: /nl/java/com.aspose.diagram/textcollection/
---
...
Bevat de tekst van een vorm. Elk item is tekst met eigenschappen voor teken, alinea en tabs.
## Methoden

| Methode | Beschrijving |
| --- | --- |
| [add(Text item)](#add-com.aspose.diagram.Text-) | Voeg het Text-object toe aan de collectie. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Text item)](#remove-com.aspose.diagram.Text-) | Verwijder het Text-object uit de collectie. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Voeg het Text-object toe aan de collectie.
...
Verwijder het Text-object uit de collectie.
