...
description: Collectie van stijlbladen.
type: docs
weight: 394
url: /nl/java/com.aspose.diagram/stylesheetcollection/
---
...
Collectie van stijlbladen.
## Methoden

| Methode | Beschrijving |
| --- | --- |
| [add(StyleSheet item)](#add-com.aspose.diagram.StyleSheet-) | Voeg StyleSheet toe aan de collectie. |
...
| [getStyleSheet(int ID)](#getStyleSheet-int-) | Haalt het element op bij de opgegeven ID. |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(StyleSheet item)](#remove-com.aspose.diagram.StyleSheet-) | Verwijder StyleSheet uit de collectie. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Voeg StyleSheet toe aan de collectie.
