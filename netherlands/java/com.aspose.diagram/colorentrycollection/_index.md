...
description: Bevat de kleurentabel van het document.
type: docs
weight: 53
url: /nl/java/com.aspose.diagram/colorentrycollection/
---
...
| --- | --- |
| [add(ColorEntry color)](#add-com.aspose.diagram.ColorEntry-) | Voeg het Color-object toe aan de collectie. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(ColorEntry color)](#remove-com.aspose.diagram.ColorEntry-) | Verwijder het Color-object uit de collectie. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Voeg het Color-object toe aan de collectie.
