...
description: Specificeert eigenschappen van de groep of vorm die gebruikt worden voor de vergelijking.
type: docs
weight: 86
url: /nl/java/com.aspose.diagram/contexttypevalue/
---
...
Specificeert eigenschappen van de groep of vorm die gebruikt moeten worden voor de vergelijking. Mogelijke waarden worden getoond in de onderstaande tabel.
## Velden
...
| [DATA_2](#DATA-2) | Data2. |
| [DATA_3](#DATA-3) | Data3. |
| [GEOMETRY_ANGLE](#GEOMETRY-ANGLE) | Geometriehoek. |
| [GEOMETRY_HEIGHT](#GEOMETRY-HEIGHT) | Geometriehoogte. |
