...
description: Issue-collectie.
type: docs
weight: 209
url: /nl/java/com.aspose.diagram/issuecollection/
---
...
| --- | --- |
| [add(Issue issue)](#add-com.aspose.diagram.Issue-) | Voeg het probleem toe aan de collectie. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Issue issue)](#remove-com.aspose.diagram.Issue-) | Verwijder het probleem uit de collectie. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Voeg het probleem toe aan de collectie.
...
Verwijder het probleem uit de collectie.
