...
| [Diagram](diagram/#constructor_1)(Stream) | Constructor de clase pública, carga el diagrama de la secuencia. |
| [Diagram](diagram/#constructor_4)(string) | Constructor de clase pública, carga el diagrama desde el archivo. |
| [Diagram](diagram/#constructor_2)(Stream, LoadFileFormat) | Constructor de clase pública, carga el diagrama de la secuencia usando un formato predefinido. |
| [Diagram](diagram/#constructor_3)(Stream, LoadOptions) | Constructor de clase pública, carga el diagrama desde la secuencia utilizando opciones de archivo de carga predefinidas. |
| [Diagram](diagram/#constructor_5)(string, LoadFileFormat) | Constructor de clase pública, carga el diagrama desde el archivo usando un formato predefinido. |
| [Diagram](diagram/#constructor_6)(string, LoadOptions) | Constructor de clase pública, carga el diagrama desde el archivo utilizando opciones de archivo de carga predefinidas. |
