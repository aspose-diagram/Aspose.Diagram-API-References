...
type: docs
weight: 70
url: /es/net/aspose.diagram.activexcontrols/checkboxactivexcontrol/
---
...
| Nombre | Descripción |
| --- | --- |
| [Accelerator](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/accelerator/) { get; set; } | Obtiene y establece la tecla aceleradora del control. |
| [Alignment](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/alignment/) { get; set; } | Obtiene y establece la posición del título en relación con el control. |
...
| [Caption](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/caption/) { get; set; } | Obtiene y establece el texto descriptivo que aparece en un control. |
...
| [GroupName](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/groupname/) { get; set; } | Obtiene y establece el nombre del grupo. |
...
| [IsChecked](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/ischecked/) { get; set; } | Indica si la casilla está marcada. |
...
| [IsTripleState](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/istriplestate/) { get; set; } | Indica cómo el control especificado mostrará valores nulos. |
| [IsWordWrapped](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/iswordwrapped/) { get; set; } | Indica si el contenido del control se ajusta automáticamente al final de una línea. |
...
| [Picture](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/picture/) { get; set; } | Obtiene y establece los datos de la imagen. |
| [PicturePosition](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/pictureposition/) { get; set; } | Obtiene y establece la ubicación de la imagen del control en relación con su título. |
| [SpecialEffect](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/specialeffect/) { get; set; } | Obtiene y establece el efecto especial del control. |
| override [Type](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/type/) { get; } | Obtiene el tipo del control ActiveX. |
| [Value](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/value/) { get; set; } | Indica si el control está marcado o no. |
