...
type: docs
weight: 260
url: /es/net/aspose.diagram.activexcontrols/labelactivexcontrol/
---
...
| Nombre | Descripción |
| --- | --- |
| [Accelerator](../../aspose.diagram.activexcontrols/labelactivexcontrol/accelerator) { get; set; } | Obtiene y establece la tecla aceleradora del control. |
...
| [BorderOleColor](../../aspose.diagram.activexcontrols/labelactivexcontrol/borderolecolor) { get; set; } | Obtiene y establece el color antiguo del fondo. |
| [BorderStyle](../../aspose.diagram.activexcontrols/labelactivexcontrol/borderstyle) { get; set; } | Obtiene y establece el tipo de borde utilizado por el control. |
| [Caption](../../aspose.diagram.activexcontrols/labelactivexcontrol/caption) { get; set; } | Obtiene y establece el texto descriptivo que aparece en un control. |
...
| [IsWordWrapped](../../aspose.diagram.activexcontrols/labelactivexcontrol/iswordwrapped) { get; set; } | Indica si el contenido del control se ajusta automáticamente al final de una línea. |
...
| [Picture](../../aspose.diagram.activexcontrols/labelactivexcontrol/picture) { get; set; } | Obtiene y establece los datos de la imagen. |
| [PicturePosition](../../aspose.diagram.activexcontrols/labelactivexcontrol/pictureposition) { get; set; } | Obtiene y establece la ubicación de la imagen del control en relación con su título. |
| [SpecialEffect](../../aspose.diagram.activexcontrols/labelactivexcontrol/specialeffect) { get; set; } | Obtiene y establece el efecto especial del control. |
| override [Type](../../aspose.diagram.activexcontrols/labelactivexcontrol/type) { get; } | Obtiene el tipo del control ActiveX. |
