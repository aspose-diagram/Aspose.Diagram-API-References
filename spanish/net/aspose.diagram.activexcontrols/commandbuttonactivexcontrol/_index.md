...
type: docs
weight: 100
url: /es/net/aspose.diagram.activexcontrols/commandbuttonactivexcontrol/
---
...
| Nombre | Descripción |
| --- | --- |
| [Accelerator](../../aspose.diagram.activexcontrols/commandbuttonactivexcontrol/accelerator/) { get; set; } | Obtiene y establece la tecla aceleradora del control. |
...
| [Caption](../../aspose.diagram.activexcontrols/commandbuttonactivexcontrol/caption/) { get; set; } | Obtiene y establece el texto descriptivo que aparece en un control. |
...
| [IsWordWrapped](../../aspose.diagram.activexcontrols/commandbuttonactivexcontrol/iswordwrapped/) { get; set; } | Indica si el contenido del control se ajusta automáticamente al final de una línea. |
...
| [Picture](../../aspose.diagram.activexcontrols/commandbuttonactivexcontrol/picture/) { get; set; } | Obtiene y establece los datos de la imagen. |
| [PicturePosition](../../aspose.diagram.activexcontrols/commandbuttonactivexcontrol/pictureposition/) { get; set; } | Obtiene y establece la ubicación de la imagen del control en relación con su título. |
| [TakeFocusOnClick](../../aspose.diagram.activexcontrols/commandbuttonactivexcontrol/takefocusonclick/) { get; set; } | Indica si el control toma el foco cuando se hace clic. |
| override [Type](../../aspose.diagram.activexcontrols/commandbuttonactivexcontrol/type/) { get; } | Obtiene el tipo del control ActiveX. |
