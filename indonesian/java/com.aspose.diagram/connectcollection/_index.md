...
description: Koleksi Connect.
type: docs
weight: 76
url: /id/java/com.aspose.diagram/connectcollection/
---
...
| Metode | Deskripsi |
| --- | --- |
| [add(Connect connect)](#add-com.aspose.diagram.Connect-) | Tambahkan koneksi ke dalam koleksi. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Connect connect)](#remove-com.aspose.diagram.Connect-) | Hapus koneksi dari koleksi. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Tambahkan koneksi ke dalam koleksi.
