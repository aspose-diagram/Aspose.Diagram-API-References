...
description: Mewakili kontrol SpinButton.
type: docs
weight: 383
url: /id/java/com.aspose.diagram/spinbuttonactivexcontrol/
---
...
| [getMax()](#getMax--) | nilai maksimum yang dapat diterima. |
| [getMin()](#getMin--) | nilai minimum yang dapat diterima. |
...
| [getOrientation()](#getOrientation--) | apakah SpinButton atau ScrollBar berorientasi secara vertikal atau horizontal. |
| [getPosition()](#getPosition--) | nilai. |
| [getSmallChange()](#getSmallChange--) | jumlah perubahan properti Position |
...
| [setMax(int value)](#setMax-int-) | Untuk deskripsi properti ini, silakan lihat [getMax()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getMax--) |
| [setMin(int value)](#setMin-int-) | Untuk deskripsi properti ini, silakan lihat [getMin()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getMin--) |
...
| [setOrientation(int value)](#setOrientation-int-) | Untuk deskripsi properti ini, silakan lihat [getOrientation()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getOrientation--) |
| [setPosition(int value)](#setPosition-int-) | Untuk deskripsi properti ini, silakan lihat [getPosition()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getPosition--) |
| [setSmallChange(int value)](#setSmallChange-int-) | Untuk deskripsi properti ini, silakan lihat [getSmallChange()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getSmallChange--) |
...
nilai maksimum yang dapat diterima.
...
apakah SpinButton atau ScrollBar berorientasi secara vertikal atau horizontal.
...
jumlah perubahan properti Position
...
Untuk deskripsi properti ini, silakan lihat [getMax()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getMax--)
...
Untuk deskripsi properti ini, silakan lihat [getMin()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getMin--)
...
Untuk deskripsi properti ini, silakan lihat [getOrientation()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getOrientation--)
...
Untuk deskripsi properti ini, silakan lihat [getPosition()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getPosition--)
...
Untuk deskripsi properti ini, silakan lihat [getSmallChange()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getSmallChange--)
