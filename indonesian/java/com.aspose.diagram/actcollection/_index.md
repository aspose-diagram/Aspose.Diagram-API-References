...
description: Koleksi Act.
type: docs
weight: 12
url: /id/java/com.aspose.diagram/actcollection/
---
...
| Metode | Deskripsi |
| --- | --- |
| [add(Act item)](#add-com.aspose.diagram.Act-) | Tambahkan objek Act ke dalam koleksi. |
...
| [getAct(int ID)](#getAct-int-) | Mendapatkan elemen pada ID yang ditentukan. |
| [getClass()](#getClass--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Act item)](#remove-com.aspose.diagram.Act-) | Hapus objek Act dari koleksi. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
