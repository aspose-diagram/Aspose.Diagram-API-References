...
description: Berisi teks dari sebuah bentuk.
type: docs
weight: 402
url: /id/java/com.aspose.diagram/textcollection/
---
...
Berisi teks sebuah bentuk. Setiap item adalah teks dengan properti karakter, paragraf, dan tab.
## Metode

| Metode | Deskripsi |
| --- | --- |
| [add(Text item)](#add-com.aspose.diagram.Text-) | Tambahkan objek Text ke dalam koleksi. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Text item)](#remove-com.aspose.diagram.Text-) | Hapus objek Text dari koleksi. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Tambahkan objek Text ke dalam koleksi.
