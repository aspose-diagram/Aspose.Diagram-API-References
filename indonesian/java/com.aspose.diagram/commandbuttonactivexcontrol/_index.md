...
description: Mewakili tombol perintah.
type: docs
weight: 56
url: /id/java/com.aspose.diagram/commandbuttonactivexcontrol/
---
...
| [getTakeFocusOnClick()](#getTakeFocusOnClick--) | Menunjukkan apakah kontrol mengambil fokus saat diklik. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAccelerator(char value)](#setAccelerator-char-) | Untuk deskripsi properti ini, silakan lihat [getAccelerator()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getAccelerator--) |
...
| [setCaption(String value)](#setCaption-java.lang.String-) | Untuk deskripsi properti ini, silakan lihat [getCaption()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getCaption--) |
...
| [setPicture(byte[] value)](#setPicture-byte---) | Untuk deskripsi properti ini, silakan lihat [getPicture()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getPicture--) |
| [setPicturePosition(int value)](#setPicturePosition-int-) | Untuk deskripsi properti ini, silakan lihat [getPicturePosition()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getPicturePosition--) |
| [setTakeFocusOnClick(boolean value)](#setTakeFocusOnClick-boolean-) | Untuk deskripsi properti ini, silakan lihat [getTakeFocusOnClick()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getTakeFocusOnClick--) |
...
| [setWordWrapped(boolean value)](#setWordWrapped-boolean-) | Untuk deskripsi properti ini, silakan lihat [isWordWrapped()](../../com.aspose.diagram/commandbuttonactivexcontrol\#isWordWrapped--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Untuk deskripsi properti ini, silakan lihat [getAccelerator()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getAccelerator--)
...
Untuk deskripsi properti ini, silakan lihat [getCaption()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getCaption--)
...
Untuk deskripsi properti ini, silakan lihat [getPicture()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getPicture--)
...
Untuk deskripsi properti ini, silakan lihat [getPicturePosition()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getPicturePosition--)
...
Untuk deskripsi properti ini, silakan lihat [getTakeFocusOnClick()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getTakeFocusOnClick--)
...
Untuk deskripsi properti ini, silakan lihat [isWordWrapped()](../../com.aspose.diagram/commandbuttonactivexcontrol\#isWordWrapped--)
