...
description: Berisi elemen yang menentukan informasi tentang busur elips. Koordinat ditentukan sebagai koordinat relatif.
type: docs
weight: 318
url: /id/java/com.aspose.diagram/relellipticalarcto/
---
...
| --- | --- |
| [RelEllipticalArcTo()](#RelEllipticalArcTo--) | Membuat sebuah instance dari kelas [EllipticalArcTo](../../com.aspose.diagram/ellipticalarcto). |
## Metode
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setA(DoubleValue value)](#setA-com.aspose.diagram.DoubleValue-) | Untuk deskripsi properti ini, silakan lihat [getA()](../../com.aspose.diagram/relellipticalarcto\#getA--) |
| [setB(DoubleValue value)](#setB-com.aspose.diagram.DoubleValue-) | Untuk deskripsi properti ini, silakan lihat [getB()](../../com.aspose.diagram/relellipticalarcto\#getB--) |
| [setC(DoubleValue value)](#setC-com.aspose.diagram.DoubleValue-) | Untuk deskripsi properti ini, silakan lihat [getC()](../../com.aspose.diagram/relellipticalarcto\#getC--) |
| [setD(DoubleValue value)](#setD-com.aspose.diagram.DoubleValue-) | Untuk deskripsi properti ini, silakan lihat [getD()](../../com.aspose.diagram/relellipticalarcto\#getD--) |
| [setDel(int value)](#setDel-int-) | Untuk deskripsi properti ini, silakan lihat [getDel()](../../com.aspose.diagram/relellipticalarcto\#getDel--) |
| [setIX(int value)](#setIX-int-) | Untuk deskripsi properti ini, silakan lihat [getIX()](../../com.aspose.diagram/relellipticalarcto\#getIX--) |
| [setX(DoubleValue value)](#setX-com.aspose.diagram.DoubleValue-) | Untuk deskripsi properti ini, silakan lihat [getX()](../../com.aspose.diagram/relellipticalarcto\#getX--) |
| [setY(DoubleValue value)](#setY-com.aspose.diagram.DoubleValue-) | Untuk deskripsi properti ini, silakan lihat [getY()](../../com.aspose.diagram/relellipticalarcto\#getY--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Untuk deskripsi properti ini, silakan lihat [getA()](../../com.aspose.diagram/relellipticalarcto\#getA--)
...
Untuk deskripsi properti ini, silakan lihat [getB()](../../com.aspose.diagram/relellipticalarcto\#getB--)
...
Untuk deskripsi properti ini, silakan lihat [getC()](../../com.aspose.diagram/relellipticalarcto\#getC--)
...
Untuk deskripsi properti ini, silakan lihat [getD()](../../com.aspose.diagram/relellipticalarcto\#getD--)
...
Untuk deskripsi properti ini, silakan lihat [getDel()](../../com.aspose.diagram/relellipticalarcto\#getDel--)
...
Untuk deskripsi properti ini, silakan lihat [getIX()](../../com.aspose.diagram/relellipticalarcto\#getIX--)
...
Untuk deskripsi properti ini, silakan lihat [getX()](../../com.aspose.diagram/relellipticalarcto\#getX--)
...
Untuk deskripsi properti ini, silakan lihat [getY()](../../com.aspose.diagram/relellipticalarcto\#getY--)
