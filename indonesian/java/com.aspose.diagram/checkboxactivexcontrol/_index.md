...
description: Mewakili kontrol CheckBox ActiveX.
type: docs
weight: 47
url: /id/java/com.aspose.diagram/checkboxactivexcontrol/
---
...
Mewakili kontrol CheckBox ActiveX.
## Metode
...
| [isChecked()](#isChecked--) | Menunjukkan apakah kotak dicentang. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAccelerator(char value)](#setAccelerator-char-) | Untuk deskripsi properti ini, silakan lihat [getAccelerator()](../../com.aspose.diagram/checkboxactivexcontrol\#getAccelerator--) |
| [setAlignment(int value)](#setAlignment-int-) | Untuk deskripsi properti ini, silakan lihat [getAlignment()](../../com.aspose.diagram/checkboxactivexcontrol\#getAlignment--) |
...
| [setCaption(String value)](#setCaption-java.lang.String-) | Untuk deskripsi properti ini, silakan lihat [getCaption()](../../com.aspose.diagram/checkboxactivexcontrol\#getCaption--) |
| [setChecked(boolean value)](#setChecked-boolean-) | Untuk deskripsi properti ini, silakan lihat [isChecked()](../../com.aspose.diagram/checkboxactivexcontrol\#isChecked--) |
...
| [setGroupName(String value)](#setGroupName-java.lang.String-) | Untuk deskripsi properti ini, silakan lihat [getGroupName()](../../com.aspose.diagram/checkboxactivexcontrol\#getGroupName--) |
...
| [setPicture(byte[] value)](#setPicture-byte---) | Untuk deskripsi properti ini, silakan lihat [getPicture()](../../com.aspose.diagram/checkboxactivexcontrol\#getPicture--) |
| [setPicturePosition(int value)](#setPicturePosition-int-) | Untuk deskripsi properti ini, silakan lihat [getPicturePosition()](../../com.aspose.diagram/checkboxactivexcontrol\#getPicturePosition--) |
| [setSpecialEffect(int value)](#setSpecialEffect-int-) | Untuk deskripsi properti ini, silakan lihat [getSpecialEffect()](../../com.aspose.diagram/checkboxactivexcontrol\#getSpecialEffect--) |
...
| [setTripleState(boolean value)](#setTripleState-boolean-) | Untuk deskripsi properti ini, silakan lihat [isTripleState()](../../com.aspose.diagram/checkboxactivexcontrol\#isTripleState--) |
| [setValue(int value)](#setValue-int-) | Untuk deskripsi properti ini, silakan lihat [getValue()](../../com.aspose.diagram/checkboxactivexcontrol\#getValue--) |
...
| [setWordWrapped(boolean value)](#setWordWrapped-boolean-) | Untuk deskripsi properti ini, silakan lihat [isWordWrapped()](../../com.aspose.diagram/checkboxactivexcontrol\#isWordWrapped--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Untuk deskripsi properti ini, silakan lihat [getAccelerator()](../../com.aspose.diagram/checkboxactivexcontrol\#getAccelerator--)
...
Untuk deskripsi properti ini, silakan lihat [getAlignment()](../../com.aspose.diagram/checkboxactivexcontrol\#getAlignment--)
...
Untuk deskripsi properti ini, silakan lihat [getCaption()](../../com.aspose.diagram/checkboxactivexcontrol\#getCaption--)
...
Untuk deskripsi properti ini, silakan lihat [isChecked()](../../com.aspose.diagram/checkboxactivexcontrol\#isChecked--)
...
Untuk deskripsi properti ini, silakan lihat [getGroupName()](../../com.aspose.diagram/checkboxactivexcontrol\#getGroupName--)
...
Untuk deskripsi properti ini, silakan lihat [getPicture()](../../com.aspose.diagram/checkboxactivexcontrol\#getPicture--)
...
Untuk deskripsi properti ini, silakan lihat [getPicturePosition()](../../com.aspose.diagram/checkboxactivexcontrol\#getPicturePosition--)
...
Untuk deskripsi properti ini, silakan lihat [getSpecialEffect()](../../com.aspose.diagram/checkboxactivexcontrol\#getSpecialEffect--)
...
Untuk deskripsi properti ini, silakan lihat [isTripleState()](../../com.aspose.diagram/checkboxactivexcontrol\#isTripleState--)
...
Untuk deskripsi properti ini, silakan lihat [getValue()](../../com.aspose.diagram/checkboxactivexcontrol\#getValue--)
...
Untuk deskripsi properti ini, silakan lihat [isWordWrapped()](../../com.aspose.diagram/checkboxactivexcontrol\#isWordWrapped--)
