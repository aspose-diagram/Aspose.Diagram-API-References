...
type: docs
weight: 424
url: /id/java/com.aspose.diagram/unknowncontrol/
---
...
| [getPersistenceType()](#getPersistenceType--) | Mendapatkan metode persistensi untuk menyimpan kontrol ActiveX. |
| [getRelationshipData(String relId)](#getRelationshipData-java.lang.String-) | Mendapatkan data hubungan. |
...
Mendapatkan metode persistensi untuk menyimpan kontrol ActiveX.
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| relId | java.lang.String | ID hubungan. |

**Returns:**
byte[] - mengembalikan data hubungan.
### getType() {#getType--}
```
public int getType()
```
