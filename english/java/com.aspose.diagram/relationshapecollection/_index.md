...
| Method | Description |
| --- | --- |
| [add(RelationShape relationShape)](#add-com.aspose.diagram.RelationShape-) | Add the relationShape in the collection. |
...
### add(RelationShape relationShape) {#add-com.aspose.diagram.RelationShape-}
```
...
```
public RelationShape get(int index)
```
...
**Returns:**
[RelationShape](../../com.aspose.diagram/relationshape) - 
### getClass() {#getClass--}
```
