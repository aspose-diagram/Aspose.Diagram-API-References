---
title: Class AutoLinkComparison
second_title: Aspose.Diagram for .NET API Reference
description: Aspose.Diagram.AutoLinkComparison class. Defines a rule that compares a column in the parent DataRecordset element with a shape data item from the last successful automatic linking action performed in the user interface
type: docs
