...
description: Executes the query string associated with the connected non-XML-based DataRecordset and updates linked shapes with new data from the data source returned by the query.
type: docs
weight: 210
