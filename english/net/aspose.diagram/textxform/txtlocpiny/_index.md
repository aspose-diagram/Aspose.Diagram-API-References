...
description: Specifies the y-coordinate of the text blocks center of rotation relative to the origin of the text block. The default formula which evaluates to the vertical center of the text block is FTxtHeight0.5.
type: docs
weight: 50
