...
description: Specifies the x-coordinate of the text blocks center of rotation in relation to the origin of the shape. The default formula which evaluates to the horizontal center of the shape is FWidth0.5.
type: docs
weight: 60
