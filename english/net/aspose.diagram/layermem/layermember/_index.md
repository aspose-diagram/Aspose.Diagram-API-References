...
description: Specifies the layer or layers to which the shape is assigned. Layer assignment is specified based on the zero-based index of layers for the page. If a shape is assigned to more than one layer each layer index appears separated by a semicolon.
type: docs
weight: 20
