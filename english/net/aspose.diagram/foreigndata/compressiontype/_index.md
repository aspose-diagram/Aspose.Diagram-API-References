...
description: This attribute is only meaningful if the foreign data is a raster-based foreign object such as a DIB JPG PNG TIFF or GIF file. The value indicates the type of compression applied to the file.
type: docs
weight: 20
