...
description: Contains the x and ycoordinates position of the second to last knot position of the last weight position of the first knot position of the first weight and the formula for a nonuniform rational Bspline NURBS. This information is specified in the X Y A B C D and E elements respectively.
type: docs
weight: 2380
