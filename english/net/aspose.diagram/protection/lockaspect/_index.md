...
description: Specifies whether the aspect ratio of the shape is locked. If locked the shape can only be sized proportionally it cannot be sized in a single dimension.
type: docs
weight: 20
