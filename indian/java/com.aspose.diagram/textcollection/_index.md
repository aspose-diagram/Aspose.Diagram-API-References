...
description: एक शेप का टेक्स्ट शामिल करता है।
type: docs
weight: 402
url: /hi/java/com.aspose.diagram/textcollection/
---
...
एक आकार के पाठ को शामिल करता है। प्रत्येक आइटम में अक्षर, पैराग्राफ और टैब गुणों वाला पाठ होता है।
## मेथड्स

| मेथड | विवरण |
| --- | --- |
| [add(Text item)](#add-com.aspose.diagram.Text-) | संग्रह में Text ऑब्जेक्ट जोड़ें। |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Text item)](#remove-com.aspose.diagram.Text-) | संग्रह से Text ऑब्जेक्ट हटाएँ। |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
संग्रह में Text ऑब्जेक्ट जोड़ें।
