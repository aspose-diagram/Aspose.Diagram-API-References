...
description: डायग्राम प्रिंट करते समय अतिरिक्त विकल्प निर्दिष्ट करने की अनुमति देता है।
type: docs
weight: 308
url: /hi/java/com.aspose.diagram/printsaveoptions/
---
...
डायग्राम प्रिंट करते समय अतिरिक्त विकल्प निर्दिष्ट करने की अनुमति देता है।
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PrintSaveOptions()](#PrintSaveOptions--) | इस वर्ग की नई इंस्टेंस को प्रारंभ करता है। |
## मेथड्स
...
| [getPageCount()](#getPageCount--) | बहु-पृष्ठ फ़ाइल में सहेजते समय रेंडर करने के लिए पृष्ठों की संख्या। |
| [getPageSize()](#getPageSize--) | जनरेट किए गए चित्रों के लिए पृष्ठ आकार। |
| [getSaveForegroundPagesOnly()](#getSaveForegroundPagesOnly--) | निर्दिष्ट करता है कि सभी पृष्ठ मुद्रित होंगे या केवल अग्रभूमि। |
...
| [setPageCount(int value)](#setPageCount-int-) | इस गुण के विवरण के लिए, कृपया देखें [getPageCount()](../../com.aspose.diagram/printsaveoptions\#getPageCount--) |
...
| [setSaveForegroundPagesOnly(boolean value)](#setSaveForegroundPagesOnly-boolean-) | इस गुण के विवरण के लिए, कृपया देखें [getSaveForegroundPagesOnly()](../../com.aspose.diagram/printsaveoptions\#getSaveForegroundPagesOnly--) |
...
बहु-पृष्ठ फ़ाइल में सहेजते समय रेंडर करने के लिए पृष्ठों की संख्या। डिफ़ॉल्ट MaxValue है, जिसका अर्थ है कि आरेख के सभी पृष्ठ मुद्रित होंगे।
...
निर्दिष्ट करता है कि सभी पृष्ठ मुद्रित होंगे या केवल अग्रभूमि। यदि true है - केवल अग्रभूमि पृष्ठ (यदि पृष्ठभूमि मौजूद हो तो उसके साथ) मुद्रित होते हैं। यदि false है - अग्रभूमि पृष्ठ (यदि पृष्ठभूमि मौजूद हो तो उसके साथ) मुद्रित होते हैं, उसके बाद खाली पृष्ठभूमि पृष्ठ। true केवल तब लौटाया जा सकता है जब PageCount > 1 हो। डिफ़ॉल्ट मान false है।
...
इस गुण के विवरण के लिए, कृपया देखें [getPageCount()](../../com.aspose.diagram/printsaveoptions\#getPageCount--)
...
इस गुण के विवरण के लिए, कृपया देखें [getSaveForegroundPagesOnly()](../../com.aspose.diagram/printsaveoptions\#getSaveForegroundPagesOnly--)
