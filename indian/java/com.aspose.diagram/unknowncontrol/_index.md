...
description: अज्ञात नियंत्रण।
type: docs
weight: 424
url: /hi/java/com.aspose.diagram/unknowncontrol/
---
...
| [getPersistenceType()](#getPersistenceType--) | ActiveX नियंत्रण को स्थायी बनाने के लिए स्थायित्व विधि प्राप्त करता है। |
| [getRelationshipData(String relId)](#getRelationshipData-java.lang.String-) | संबंध डेटा प्राप्त करता है। |
...
ActiveX नियंत्रण को स्थायी बनाने के लिए स्थायित्व विधि प्राप्त करता है।
...
| पैरामीटर | टाइप | विवरण |
| --- | --- | --- |
| relId | java.lang.String | संबंध आईडी। |

**Returns:**
byte[] - संबंध डेटा लौटाता है।
### getType() {#getType--}
```
public int getType()
```
