...
type: docs
weight: 289
url: /hi/java/com.aspose.diagram/placestyle/
---
...
| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PlaceStyle(int value)](#PlaceStyle-int-) | कंस्ट्रक्टर। |
## मेथड्स
...
| [getValue()](#getValue--) | जब उपयोगकर्ता Lay Out Shapes (Shape मेनू) चुनता है, तो पृष्ठ पर आकारों को कैसे रखा जाता है, यह निर्दिष्ट करता है। |
| [hashCode()](#hashCode--) | किसी विशेष प्रकार के लिए हैश फ़ंक्शन के रूप में कार्य करता है। |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setValue(int value)](#setValue-int-) | इस प्रॉपर्टी के विवरण के लिए, कृपया देखें [getValue()](../../com.aspose.diagram/placestyle\#getValue--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
इस प्रॉपर्टी के विवरण के लिए, कृपया देखें [getValue()](../../com.aspose.diagram/placestyle\#getValue--)
