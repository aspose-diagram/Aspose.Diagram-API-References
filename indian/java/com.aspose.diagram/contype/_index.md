...
type: docs
weight: 73
url: /hi/java/com.aspose.diagram/contype/
---
...
| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [ConType(int value)](#ConType-int-) | कंस्ट्रक्टर। |
## मेथड्स
...
| [getValue()](#getValue--) | हैंडल को स्थानांतरित करने के बाद नियंत्रण हैंडल के x या y-निर्देशांक द्वारा प्रदर्शित व्यवहार के प्रकार को निर्दिष्ट करता है। |
| [hashCode()](#hashCode--) | किसी विशेष प्रकार के लिए हैश फ़ंक्शन के रूप में कार्य करता है। |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setUfe(UnitFormulaErr value)](#setUfe-com.aspose.diagram.UnitFormulaErr-) | इस प्रॉपर्टी का विवरण देखने के लिए, कृपया देखें [getUfe()](../../com.aspose.diagram/contype\#getUfe--) |
| [setValue(int value)](#setValue-int-) | इस प्रॉपर्टी का विवरण देखने के लिए, कृपया देखें [getValue()](../../com.aspose.diagram/contype\#getValue--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
इस प्रॉपर्टी का विवरण देखने के लिए, कृपया देखें [getUfe()](../../com.aspose.diagram/contype\#getUfe--)
...
इस प्रॉपर्टी का विवरण देखने के लिए, कृपया देखें [getValue()](../../com.aspose.diagram/contype\#getValue--)
