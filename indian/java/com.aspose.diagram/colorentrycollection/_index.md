...
description: दस्तावेज़ की रंग तालिका शामिल करता है।
type: docs
weight: 53
url: /hi/java/com.aspose.diagram/colorentrycollection/
---
...
| मेथड | विवरण |
| --- | --- |
| [add(ColorEntry color)](#add-com.aspose.diagram.ColorEntry-) | संग्रह में Color ऑब्जेक्ट जोड़ें। |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(ColorEntry color)](#remove-com.aspose.diagram.ColorEntry-) | संग्रह से Color ऑब्जेक्ट हटाएँ। |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
संग्रह में Color ऑब्जेक्ट जोड़ें।
...
संग्रह से Color ऑब्जेक्ट हटाएँ।
