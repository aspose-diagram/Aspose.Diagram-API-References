...
description: मटर्ड सर्वजनक और नज कुंज सेट करत है यद आप मटर्ड लइसेंस खरदते हैं त आवेदन शुरू करते समय इस एपआई क कल कय जन चहए समन्य रूप से यह पर्यप्त है हलंक यद खपत डेट अपलड करने में हमेश वफल रहत है और 24 घंटे से अधक ह जत है त लइसेंस मूल्यंकन स्थत पर सेट ह जएग ऐसे ममले से बचने के लए आपक नयमत रूप से लइसेंस स्थत क जंच करन चहए यद यह मूल्यंकन स्थत है त इस एपआई क फर से कल करें
type: docs
weight: 20
url: /hi/net/aspose.diagram/metered/setmeteredkey/
---
