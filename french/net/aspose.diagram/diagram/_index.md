...
| [Diagram](diagram#constructor_1)(Stream) | PubliqueDiagram constructeur de classe, charge le diagramme à partir du flux. |
| [Diagram](diagram#constructor_4)(string) | PubliqueDiagram constructeur de classe, charge le diagramme à partir du fichier. |
| [Diagram](diagram#constructor_2)(Stream, LoadFileFormat) | PubliqueDiagram constructeur de classe, charge le diagramme à partir du flux en utilisant un format prédéfini. |
| [Diagram](diagram#constructor_3)(Stream, LoadOptions) | PubliqueDiagram constructeur de classe, charge le diagramme à partir du flux à l'aide d'options de fichier de chargement prédéfinies. |
| [Diagram](diagram#constructor_5)(string, LoadFileFormat) | PubliqueDiagramconstructeur de classe, charge le diagramme à partir du fichier en utilisant le format prédéfini. |
| [Diagram](diagram#constructor_6)(string, LoadOptions) | PubliqueDiagram constructeur de classe, charge le diagramme à partir du fichier à l'aide d'options de fichier de chargement prédéfinies. |
