...
| [TextCompression](../../aspose.diagram.saving/pdfsaveoptions/textcompression) { get; set; } | Spécifie le type de compression à utiliser pour tous les flux de contenu à l'exception des images. La valeur par défaut est!:PdfTextCompressionCore.Flate. |
