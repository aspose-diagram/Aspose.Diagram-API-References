...
type: docs
weight: 402
url: /fr/java/com.aspose.diagram/textcollection/
---
...
Contient le texte d'une forme. Chaque élément est du texte avec des propriétés de caractère, de paragraphe et d'onglets.
## Méthodes

| Méthode | Description |
| --- | --- |
| [add(Text item)](#add-com.aspose.diagram.Text-) | Ajouter l'objet Text à la collection. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Text item)](#remove-com.aspose.diagram.Text-) | Supprimer l'objet Text de la collection. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Ajouter l'objet Text à la collection.
...
Supprimer l'objet Text de la collection.
