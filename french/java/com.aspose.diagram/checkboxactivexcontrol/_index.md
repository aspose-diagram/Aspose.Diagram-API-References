...
type: docs
weight: 47
url: /fr/java/com.aspose.diagram/checkboxactivexcontrol/
---
...
| [getAccelerator()](#getAccelerator--) | la touche d'accélérateur du contrôle. |
| [getAlignment()](#getAlignment--) | la position de la légende Caption par rapport au contrôle. |
| [getBackOleColor()](#getBackOleColor--) | la couleur OLE de l'arrière-plan. |
| [getCaption()](#getCaption--) | le texte descriptif qui apparaît sur un contrôle. |
| [getClass()](#getClass--) |  |
| [getData()](#getData--) | les données binaires du contrôle. |
| [getForeOleColor()](#getForeOleColor--) | la couleur OLE du premier plan. |
| [getGroupName()](#getGroupName--) | le nom du groupe. |
...
| [getPicture()](#getPicture--) | les données de l'image. |
| [getPicturePosition()](#getPicturePosition--) | l'emplacement de l'image du contrôle par rapport à sa légende. |
| [getSpecialEffect()](#getSpecialEffect--) | l'effet spécial du contrôle. |
| [getType()](#getType--) | Obtient le type du contrôle ActiveX. |
| [getValue()](#getValue--) | Indique si le contrôle est coché ou non. |
...
| [isChecked()](#isChecked--) | Indique si la case est cochée. |
...
| [isTripleState()](#isTripleState--) | Indique comment le contrôle spécifié affichera les valeurs Null. |
| [isWordWrapped()](#isWordWrapped--) | Indique si le contenu du contrôle passe automatiquement à la ligne à la fin d'une ligne. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAccelerator(char value)](#setAccelerator-char-) | Pour la description de cette propriété, veuillez consulter [getAccelerator()](../../com.aspose.diagram/checkboxactivexcontrol\#getAccelerator--) |
| [setAlignment(int value)](#setAlignment-int-) | Pour la description de cette propriété, veuillez consulter [getAlignment()](../../com.aspose.diagram/checkboxactivexcontrol\#getAlignment--) |
...
| [setCaption(String value)](#setCaption-java.lang.String-) | Pour la description de cette propriété, veuillez consulter [getCaption()](../../com.aspose.diagram/checkboxactivexcontrol\#getCaption--) |
| [setChecked(boolean value)](#setChecked-boolean-) | Pour la description de cette propriété, veuillez consulter [isChecked()](../../com.aspose.diagram/checkboxactivexcontrol\#isChecked--) |
...
| [setGroupName(String value)](#setGroupName-java.lang.String-) | Pour la description de cette propriété, veuillez consulter [getGroupName()](../../com.aspose.diagram/checkboxactivexcontrol\#getGroupName--) |
...
| [setPicture(byte[] value)](#setPicture-byte---) | Pour la description de cette propriété, veuillez consulter [getPicture()](../../com.aspose.diagram/checkboxactivexcontrol\#getPicture--) |
| [setPicturePosition(int value)](#setPicturePosition-int-) | Pour la description de cette propriété, veuillez consulter [getPicturePosition()](../../com.aspose.diagram/checkboxactivexcontrol\#getPicturePosition--) |
| [setSpecialEffect(int value)](#setSpecialEffect-int-) | Pour la description de cette propriété, veuillez consulter [getSpecialEffect()](../../com.aspose.diagram/checkboxactivexcontrol\#getSpecialEffect--) |
...
| [setTripleState(boolean value)](#setTripleState-boolean-) | Pour la description de cette propriété, veuillez consulter [isTripleState()](../../com.aspose.diagram/checkboxactivexcontrol\#isTripleState--) |
| [setValue(int value)](#setValue-int-) | Pour la description de cette propriété, veuillez consulter [getValue()](../../com.aspose.diagram/checkboxactivexcontrol\#getValue--) |
...
| [setWordWrapped(boolean value)](#setWordWrapped-boolean-) | Pour la description de cette propriété, veuillez consulter [isWordWrapped()](../../com.aspose.diagram/checkboxactivexcontrol\#isWordWrapped--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
la touche d'accélérateur du contrôle.
...
la position de la légende Caption par rapport au contrôle.
...
le texte descriptif qui apparaît sur un contrôle.
...
l'emplacement de l'image du contrôle par rapport à sa légende.
...
| True    | Le contrôle parcourra les états pour les valeurs Oui, Non et Null. Le contrôle apparaît atténué (gris) lorsque sa propriété Value est définie sur Null. |
| False   | (Par défaut) Le contrôle parcourra les états pour les valeurs Oui et Non. Les valeurs Null s'affichent comme si elles étaient des valeurs Non.                           |
...
Pour la description de cette propriété, veuillez consulter [getAccelerator()](../../com.aspose.diagram/checkboxactivexcontrol\#getAccelerator--)
...
Pour la description de cette propriété, veuillez consulter [getAlignment()](../../com.aspose.diagram/checkboxactivexcontrol\#getAlignment--)
...
Pour la description de cette propriété, veuillez consulter [getCaption()](../../com.aspose.diagram/checkboxactivexcontrol\#getCaption--)
...
Pour la description de cette propriété, veuillez consulter [isChecked()](../../com.aspose.diagram/checkboxactivexcontrol\#isChecked--)
...
Pour la description de cette propriété, veuillez consulter [getGroupName()](../../com.aspose.diagram/checkboxactivexcontrol\#getGroupName--)
...
Pour la description de cette propriété, veuillez consulter [getPicture()](../../com.aspose.diagram/checkboxactivexcontrol\#getPicture--)
...
Pour la description de cette propriété, veuillez consulter [getPicturePosition()](../../com.aspose.diagram/checkboxactivexcontrol\#getPicturePosition--)
...
Pour la description de cette propriété, veuillez consulter [getSpecialEffect()](../../com.aspose.diagram/checkboxactivexcontrol\#getSpecialEffect--)
...
Pour la description de cette propriété, veuillez consulter [isTripleState()](../../com.aspose.diagram/checkboxactivexcontrol\#isTripleState--)
...
Pour la description de cette propriété, veuillez consulter [getValue()](../../com.aspose.diagram/checkboxactivexcontrol\#getValue--)
...
Pour la description de cette propriété, veuillez consulter [isWordWrapped()](../../com.aspose.diagram/checkboxactivexcontrol\#isWordWrapped--)
