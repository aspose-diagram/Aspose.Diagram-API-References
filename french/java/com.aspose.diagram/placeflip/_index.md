...
description: Spécifie comment les formes placables sont retournées et/ou pivotées sur une page lorsque les formes sont disposées à l'aide de la commande Disposer les formes dans Microsoft Visio.
type: docs
weight: 287
url: /fr/java/com.aspose.diagram/placeflip/
---
...
| --- | --- |
| [PlaceFlip(int value)](#PlaceFlip-int-) | Constructeur. |
## Méthodes
...
| [getValue()](#getValue--) | Spécifie comment les formes placables sont retournées et/ou pivotées sur une page lorsque les formes sont disposées à l'aide de la commande Disposer les formes dans Microsoft Visio. |
