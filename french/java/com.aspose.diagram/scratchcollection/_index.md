...
description: Collection Scratch.
type: docs
weight: 351
url: /fr/java/com.aspose.diagram/scratchcollection/
---
...
| Méthode | Description |
| --- | --- |
| [add(Scratch item)](#add-com.aspose.diagram.Scratch-) | Ajoutez l'objet Scratch dans la collection. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Scratch item)](#remove-com.aspose.diagram.Scratch-) | Supprimez l'objet Scratch de la collection. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Ajoutez l'objet Scratch dans la collection.
...
Supprimez l'objet Scratch de la collection.
