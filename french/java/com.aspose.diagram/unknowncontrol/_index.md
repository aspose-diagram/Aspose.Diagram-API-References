...
type: docs
weight: 424
url: /fr/java/com.aspose.diagram/unknowncontrol/
---
...
| [getPersistenceType()](#getPersistenceType--) | Obtient la méthode de persistance pour persister un contrôle ActiveX. |
| [getRelationshipData(String relId)](#getRelationshipData-java.lang.String-) | Obtient les données de la relation. |
...
Obtient la méthode de persistance pour persister un contrôle ActiveX.
...
Obtient les données de la relation.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| relId | java.lang.String | L'identifiant de la relation. |

**Returns:**
byte[] - renvoie les données de la relation.
### getType() {#getType--}
```
public int getType()
```
