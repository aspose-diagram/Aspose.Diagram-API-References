...
type: docs
weight: 342
url: /fr/java/com.aspose.diagram/rulesetcollection/
---
...
| Méthode | Description |
| --- | --- |
| [add(RuleSet ruleSet)](#add-com.aspose.diagram.RuleSet-) | Ajoutez le ruleSet dans la collection. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(RuleSet ruleSet)](#remove-com.aspose.diagram.RuleSet-) | Supprimez le ruleSet de la collection. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Ajoutez le ruleSet dans la collection.
...
Supprimez le ruleSet de la collection.
