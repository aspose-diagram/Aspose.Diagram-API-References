...
type: docs
weight: 243
url: /fr/java/com.aspose.diagram/mastershortcutcollection/
---
...
| Méthode | Description |
| --- | --- |
| [add(MasterShortcut masterShortcut)](#add-com.aspose.diagram.MasterShortcut-) | Ajoutez l'objet Master dans la collection. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(MasterShortcut masterShortcut)](#remove-com.aspose.diagram.MasterShortcut-) | Supprimez l'objet MasterShortcut de la collection. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Ajoutez l'objet Master dans la collection.
...
Supprimez l'objet MasterShortcut de la collection.
