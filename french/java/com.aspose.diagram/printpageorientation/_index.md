...
type: docs
weight: 305
url: /fr/java/com.aspose.diagram/printpageorientation/
---
...
| --- | --- |
| [PrintPageOrientation(PrintProps pp, int value)](#PrintPageOrientation-com.aspose.diagram.PrintProps-int-) | Constructeur. |
## Méthodes
...
| [getValue()](#getValue--) | Détermine si la page est imprimée en orientation portrait ou paysage. |
| [hashCode()](#hashCode--) | Servit de fonction de hachage pour un type particulier. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setValue(int value)](#setValue-int-) | Pour la description de cette propriété, veuillez consulter [getValue()](../../com.aspose.diagram/printpageorientation\#getValue--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Pour la description de cette propriété, veuillez consulter [getValue()](../../com.aspose.diagram/printpageorientation\#getValue--)
