...
type: docs
weight: 394
url: /fr/java/com.aspose.diagram/stylesheetcollection/
---
...
| Méthode | Description |
| --- | --- |
| [add(StyleSheet item)](#add-com.aspose.diagram.StyleSheet-) | Ajouter une feuille de style dans la collection. |
...
| [getStyleSheet(int ID)](#getStyleSheet-int-) | Obtient l'élément à l'ID spécifié. |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(StyleSheet item)](#remove-com.aspose.diagram.StyleSheet-) | Supprimer la feuille de style de la collection. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Ajouter une feuille de style dans la collection.
...
Supprimer la feuille de style de la collection.
