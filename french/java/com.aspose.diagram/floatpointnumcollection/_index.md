...
description: Contient une collection de nombres à virgule flottante double précision.
type: docs
weight: 156
url: /fr/java/com.aspose.diagram/floatpointnumcollection/
---
...
Contient une collection de nombres à virgule flottante double précision.
## Constructeurs
...
| Méthode | Description |
| --- | --- |
| [add(double number)](#add-double-) | Ajoute le nombre de points de doublement dans la collection. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(double number)](#remove-double-) | Supprime le nombre de points de doublement de la collection. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Ajoute le nombre de points de doublement dans la collection.
...
Supprime le nombre de points de doublement de la collection.
