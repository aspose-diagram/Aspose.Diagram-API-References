...
description: Spécifie le paramètre actuel du comportement de redimensionnement pour la forme lorsqu’elle est contenue dans un groupe.
type: docs
weight: 328
url: /fr/java/com.aspose.diagram/resizemode/
---
...
Spécifie le paramètre actuel du comportement de redimensionnement pour la forme lorsqu’elle est contenue dans un groupe.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [ResizeMode(int value)](#ResizeMode-int-) | Constructeur. |
## Méthodes
...
| [getValue()](#getValue--) | Spécifie le paramètre actuel du comportement de redimensionnement pour la forme lorsqu’elle est contenue dans un groupe. |
