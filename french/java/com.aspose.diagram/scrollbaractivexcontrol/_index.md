...
type: docs
weight: 352
url: /fr/java/com.aspose.diagram/scrollbaractivexcontrol/
---
...
| [getLargeChange()](#getLargeChange--) | le montant par lequel la propriété Position change |
| [getMax()](#getMax--) | la valeur maximale acceptable. |
| [getMin()](#getMin--) | la valeur minimale acceptable. |
...
| [getOrientation()](#getOrientation--) | si le SpinButton ou la ScrollBar est orienté verticalement ou horizontalement. |
| [getPosition()](#getPosition--) | la valeur. |
| [getSmallChange()](#getSmallChange--) | le montant par lequel la propriété Position change |
...
| [setLargeChange(int value)](#setLargeChange-int-) | Pour la description de cette propriété, veuillez consulter [getLargeChange()](../../com.aspose.diagram/scrollbaractivexcontrol\#getLargeChange--) |
...
| [setMax(int value)](#setMax-int-) | Pour la description de cette propriété, veuillez consulter [getMax()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getMax--) |
| [setMin(int value)](#setMin-int-) | Pour la description de cette propriété, veuillez consulter [getMin()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getMin--) |
...
| [setOrientation(int value)](#setOrientation-int-) | Pour la description de cette propriété, veuillez consulter [getOrientation()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getOrientation--) |
| [setPosition(int value)](#setPosition-int-) | Pour la description de cette propriété, veuillez consulter [getPosition()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getPosition--) |
| [setSmallChange(int value)](#setSmallChange-int-) | Pour la description de cette propriété, veuillez consulter [getSmallChange()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getSmallChange--) |
...
le montant par lequel la propriété Position change
...
si le SpinButton ou la ScrollBar est orienté verticalement ou horizontalement.
...
Pour la description de cette propriété, veuillez consulter [getLargeChange()](../../com.aspose.diagram/scrollbaractivexcontrol\#getLargeChange--)
...
Pour la description de cette propriété, veuillez consulter [getMax()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getMax--)
...
Pour la description de cette propriété, veuillez consulter [getMin()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getMin--)
...
Pour la description de cette propriété, veuillez consulter [getOrientation()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getOrientation--)
...
Pour la description de cette propriété, veuillez consulter [getPosition()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getPosition--)
...
Pour la description de cette propriété, veuillez consulter [getSmallChange()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getSmallChange--)
