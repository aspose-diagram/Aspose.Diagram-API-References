...
type: docs
weight: 132
url: /fr/java/com.aspose.diagram/drawingscaletypevalue/
---
...
| Champ | Description |
| --- | --- |
| [ARCHITECTURAL_SCALE](#ARCHITECTURAL-SCALE) | Échelle architecturale. |
| [CIVIL_ENGINEERING_SCALE](#CIVIL-ENGINEERING-SCALE) | Échelle de génie civil. |
| [CUSTOM_SCALE](#CUSTOM-SCALE) | Échelle personnalisée. |
| [MECHANICAL_ENGINEERING_SCALE](#MECHANICAL-ENGINEERING-SCALE) | Échelle de génie mécanique. |
| [METRIC_SCALE](#METRIC-SCALE) | Échelle métrique. |
| [NO_SCALE](#NO-SCALE) | Pas d'échelle. |
