...
description: Spécifie quels connecteurs dynamiques espacer s'ils sont routés les uns sur les autres.
type: docs
weight: 222
url: /fr/java/com.aspose.diagram/lineadjustfrom/
---
...
| --- | --- |
| [LineAdjustFrom(int value)](#LineAdjustFrom-int-) | Constructeur. |
## Méthodes
...
| [getValue()](#getValue--) | Spécifie quels connecteurs dynamiques espacer s'ils sont routés les uns sur les autres. |
