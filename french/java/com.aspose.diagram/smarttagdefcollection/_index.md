...
type: docs
weight: 375
url: /fr/java/com.aspose.diagram/smarttagdefcollection/
---
...
| Méthode | Description |
| --- | --- |
| [add(SmartTagDef item)](#add-com.aspose.diagram.SmartTagDef-) | Ajoutez l’objet SmartTagDef dans la collection. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(SmartTagDef item)](#remove-com.aspose.diagram.SmartTagDef-) | Supprimez l’objet SmartTagDef de la collection. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Ajoutez l’objet SmartTagDef dans la collection.
...
Supprimez l’objet SmartTagDef de la collection.
