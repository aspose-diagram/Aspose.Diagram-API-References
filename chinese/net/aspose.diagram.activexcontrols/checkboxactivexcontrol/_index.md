...
| [Alignment](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/alignment/) { get; set; } | 获取和设置 Caption 相对于控件的位置。 |
...
| [IsChecked](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/ischecked/) { get; set; } | 表示该框是否被选中。 |
...
| [IsWordWrapped](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/iswordwrapped/) { get; set; } | 表示控件内容是否自动换行。 |
...
| [PicturePosition](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/pictureposition/) { get; set; } | 获取和设置控件图片相对于其标题的位置。 |
| [SpecialEffect](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/specialeffect/) { get; set; } | 获取和设置控件的特效。 |
