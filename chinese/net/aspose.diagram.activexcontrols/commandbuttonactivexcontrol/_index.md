...
| [IsWordWrapped](../../aspose.diagram.activexcontrols/commandbuttonactivexcontrol/iswordwrapped) { get; set; } | 表示控件的内容是否在行尾自动换行。 |
...
| [PicturePosition](../../aspose.diagram.activexcontrols/commandbuttonactivexcontrol/pictureposition) { get; set; } | 获取并设置控件图片相对于其标题的位置。 |
| [TakeFocusOnClick](../../aspose.diagram.activexcontrols/commandbuttonactivexcontrol/takefocusonclick) { get; set; } | 指示控件在单击时是否获得焦点。 |
