...
| [BorderOleColor](../../aspose.diagram.activexcontrols/labelactivexcontrol/borderolecolor) { get; set; } | 获取和设置背景的ole颜色。 |
...
| [IsWordWrapped](../../aspose.diagram.activexcontrols/labelactivexcontrol/iswordwrapped) { get; set; } | 表示控件的内容是否在行尾自动换行。 |
...
| [PicturePosition](../../aspose.diagram.activexcontrols/labelactivexcontrol/pictureposition) { get; set; } | 获取并设置控件图片相对于其标题的位置。 |
| [SpecialEffect](../../aspose.diagram.activexcontrols/labelactivexcontrol/specialeffect) { get; set; } | 获取和设置控件的特殊效果。 |
