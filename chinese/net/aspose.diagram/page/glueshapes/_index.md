...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| shapeFrom | Shape | 胶水的形状[`Shape`](../../shape/). |
| placeTo | ConnectionPointPlace | 第一个形状上的粘合位置[`ConnectionPointPlace`](../../../aspose.diagram.manipulation/connectionpointplace/). |
| shapeTo | Shape | 粘贴到的形状[`Shape`](../../shape/). |
