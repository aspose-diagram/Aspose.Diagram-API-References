...
| [Diagram](diagram#constructor_1)(Stream) | PublicDiagram类构造函数， 从流中加载图表。 |
| [Diagram](diagram#constructor_4)(string) | PublicDiagram类构造函数， 从文件中加载图表。 |
| [Diagram](diagram#constructor_2)(Stream, LoadFileFormat) | PublicDiagram类构造函数， 使用预定义格式从流中加载图表。 |
| [Diagram](diagram#constructor_3)(Stream, LoadOptions) | PublicDiagram类构造函数, 使用预定义的加载文件选项从流中加载图表. |
| [Diagram](diagram#constructor_5)(string, LoadFileFormat) | PublicDiagram类构造函数， 使用预定义格式从文件中加载图表。 |
| [Diagram](diagram#constructor_6)(string, LoadOptions) | PublicDiagram类构造函数, 使用预定义的加载文件选项从文件加载图表. |
...
| [Colors](../../aspose.diagram/diagram/colors) { get; } | 包含文档的颜色表。每个文档都包含一个颜色表 ，它列出了可用于对象 的 24 种标准颜色，例如文档中的形状、文本和图层。 |
...
| [Fonts](../../aspose.diagram/diagram/fonts) { get; } | 包含 Font 元素的集合 |
...
| [Key](../../aspose.diagram/diagram/key) { get; set; } | 指示文档是否已在 Visio 外部修改。如果存在，Visio 将全面测试文件的内容。省略您在 Visio 之外创建的文件。 |
| [Masters](../../aspose.diagram/diagram/masters) { get; } | 集合主对象。 |
| [Metric](../../aspose.diagram/diagram/metric) { get; set; } | 图纸中是否使用公制单位。将此属性设置为 True (1) 以使用公制单位；将其设置为 False (0) 以使用英制单位。 |
...
| [Start](../../aspose.diagram/diagram/start) { get; set; } | 指示文档是否已在 Visio 外部修改。 如果存在，Visio 将全面测试文件的内容。省略您在 Visio 之外创建的文件。 |
...
| [Validation](../../aspose.diagram/diagram/validation) { get; } | 存储有关文档的图表验证的信息。 |
| [VbaProject](../../aspose.diagram/diagram/vbaproject) { get; } | 获取 VbaProject[`VbaProject`](./vbaproject)。 |
| [VbProjectData](../../aspose.diagram/diagram/vbprojectdata) { get; set; } | 包含采用 MIME（多用途 Internet 邮件扩展）编码格式的 Microsoft Visual Basic for Applications 项目数据。 |
| [Version](../../aspose.diagram/diagram/version) { get; set; } | Visio 实例的版本号。 Microsoft Visio 2010 = 14. |
...
| 姓名 | 描述 |
| --- | --- |
| [AddMaster](../../aspose.diagram/diagram/addmaster#addmaster)(Diagram, string) | 通过主控名称或 NameU 从源图中将主控添加到图。 |
| [AddMaster](../../aspose.diagram/diagram/addmaster#addmaster_1)(Stream, int) | 通过 master 的 ID 从模板流向图表添加 master。 |
| [AddMaster](../../aspose.diagram/diagram/addmaster#addmaster_2)(Stream, string) | 通过主控名称或 NameU 从模板流向图表添加主控。 |
| [AddMaster](../../aspose.diagram/diagram/addmaster#addmaster_3)(string, int) | 通过主 ID 从模板文件将主添加到图表。 |
| [AddMaster](../../aspose.diagram/diagram/addmaster#addmaster_4)(string, string) | 将模板文件中的母版添加到图表中，通过母版的名称或 NameU。 |
| [AddShape](../../aspose.diagram/diagram/addshape#addshape)(Shape, string, int) | 将母版创建的形状添加到特定页面。 |
| [AddShape](../../aspose.diagram/diagram/addshape#addshape_2)(double, double, string, int) | 添加母版在页面上创建的具有已定义 PinX 和 PinY 的形状。 |
| [AddShape](../../aspose.diagram/diagram/addshape#addshape_1)(double, double, double, double, string, int) | 添加母版在页面上创建的具有已定义 PinX、PinY、宽度和高度的形状。 |
| [Combine](../../aspose.diagram/diagram/combine)(Diagram) | 组合另一个图表对象。 |
| [CopyTheme](../../aspose.diagram/diagram/copytheme)(Diagram) | 从源图表复制主题。 |
| [Dispose](../../aspose.diagram/diagram/dispose)() | 执行与释放、释放或 重置非托管资源相关的应用程序定义任务。 |
| [GetDefaultFontDir](../../aspose.diagram/diagram/getdefaultfontdir)() | 获取默认字体文件夹路径 |
| [GetUnusedStyles](../../aspose.diagram/diagram/getunusedstyles)() | 获取未使用的样式 |
| [HasHiddenInfo](../../aspose.diagram/diagram/hashiddeninfo)() | 表示此图是否有隐藏信息。 |
| [Layout](../../aspose.diagram/diagram/layout)(LayoutOptions) | 为图表的所有页面布置形状和/或重新路由连接器。 |
...
| [Print](../../aspose.diagram/diagram/print#print_6)(string) | 使用标准（无用户界面）打印控制器将整个文档打印到指定的打印机。 |
...
| [Print](../../aspose.diagram/diagram/print#print_7)(string, PrintSaveOptions) | 使用标准（无用户界面）打印控制器将整个文档打印到指定的打印机。 |
...
| [Save](../../aspose.diagram/diagram/save#save_3)(string, SaveOptions) | 使用指定的保存选项将文档保存到文件中。 |
