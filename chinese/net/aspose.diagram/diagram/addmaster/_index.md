...
description: 通过主控名称或 NameU 从源图中将主控添加到图
type: docs
weight: 310
...
通过 master 的 ID 从模板流向图表添加 master。
...
将模板文件中的母版添加到图表中，通过母版的名称或 NameU。
