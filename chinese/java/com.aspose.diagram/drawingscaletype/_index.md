...
description: 指定页面使用的绘图比例类型。
type: docs
weight: 131
url: /zh/java/com.aspose.diagram/drawingscaletype/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [DrawingScaleType(int value)](#DrawingScaleType-int-) | 构造函数。 |
## 方法
...
| [getValue()](#getValue--) | 指定页面使用的绘图比例类型。 |
