...
description: 指定在形状文本块中应用于一段文本的字符格式。
type: docs
weight: 391
url: /zh/java/com.aspose.diagram/style/
---
...
指定在形状文本块中应用于一段文本的字符格式。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [Style(int value)](#Style-int-) | 构造函数。 |
## 方法
...
| [getValue()](#getValue--) | 指定在形状文本块中应用于一段文本的字符格式。 |
