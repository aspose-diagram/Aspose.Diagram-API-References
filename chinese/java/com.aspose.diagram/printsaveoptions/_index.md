...
type: docs
weight: 308
url: /zh/java/com.aspose.diagram/printsaveoptions/
---
...
| [getPageCount()](#getPageCount--) | 在保存为多页文件时要渲染的页数。 |
| [getPageSize()](#getPageSize--) | 生成图像的页面尺寸。 |
| [getSaveForegroundPagesOnly()](#getSaveForegroundPagesOnly--) | 指定是打印所有页还是仅打印前景页。 |
...
| [setPageCount(int value)](#setPageCount-int-) | 有关此属性的描述，请参阅 [getPageCount()](../../com.aspose.diagram/printsaveoptions\#getPageCount--) |
...
| [setSaveForegroundPagesOnly(boolean value)](#setSaveForegroundPagesOnly-boolean-) | 有关此属性的描述，请参阅 [getSaveForegroundPagesOnly()](../../com.aspose.diagram/printsaveoptions\#getSaveForegroundPagesOnly--) |
...
在保存为多页文件时要渲染的页数。默认值为 MaxValue，表示将打印图表的所有页。
...
指定是打印所有页还是仅打印前景页。如果为 true，则仅打印前景页（如果存在背景则一起打印）。如果为 false，则先打印前景页（如果存在背景则一起打印），随后打印空的背景页。仅当 PageCount > 1 时才可能返回 true。默认值为 false。
...
有关此属性的描述，请参阅 [getPageCount()](../../com.aspose.diagram/printsaveoptions\#getPageCount--)
...
有关此属性的描述，请参阅 [getSaveForegroundPagesOnly()](../../com.aspose.diagram/printsaveoptions\#getSaveForegroundPagesOnly--)
