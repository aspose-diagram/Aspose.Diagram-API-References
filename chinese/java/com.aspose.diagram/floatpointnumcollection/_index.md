...
description: 包含双倍点数的集合
type: docs
weight: 156
url: /zh/java/com.aspose.diagram/floatpointnumcollection/
---
...
| 方法 | 描述 |
| --- | --- |
| [add(double number)](#add-double-) | 在集合中添加双倍点数。 |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(double number)](#remove-double-) | 从集合中移除双倍点数。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
