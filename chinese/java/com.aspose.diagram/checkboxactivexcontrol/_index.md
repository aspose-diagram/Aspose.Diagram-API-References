...
description: 表示一个 CheckBox ActiveX 控件。
type: docs
weight: 47
url: /zh/java/com.aspose.diagram/checkboxactivexcontrol/
---
...
| [getAlignment()](#getAlignment--) | Caption 相对于控件的位置。 |
...
| [getGroupName()](#getGroupName--) | 组的名称。 |
...
| [isChecked()](#isChecked--) | 指示该复选框是否被选中。 |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAccelerator(char value)](#setAccelerator-char-) | 有关此属性的描述，请参阅 [getAccelerator()](../../com.aspose.diagram/checkboxactivexcontrol\#getAccelerator--) |
| [setAlignment(int value)](#setAlignment-int-) | 有关此属性的描述，请参阅 [getAlignment()](../../com.aspose.diagram/checkboxactivexcontrol\#getAlignment--) |
...
| [setCaption(String value)](#setCaption-java.lang.String-) | 有关此属性的描述，请参阅 [getCaption()](../../com.aspose.diagram/checkboxactivexcontrol\#getCaption--) |
| [setChecked(boolean value)](#setChecked-boolean-) | 有关此属性的描述，请参阅 [isChecked()](../../com.aspose.diagram/checkboxactivexcontrol\#isChecked--) |
...
| [setGroupName(String value)](#setGroupName-java.lang.String-) | 有关此属性的描述，请参阅 [getGroupName()](../../com.aspose.diagram/checkboxactivexcontrol\#getGroupName--) |
...
| [setPicture(byte[] value)](#setPicture-byte---) | 有关此属性的描述，请参阅 [getPicture()](../../com.aspose.diagram/checkboxactivexcontrol\#getPicture--) |
| [setPicturePosition(int value)](#setPicturePosition-int-) | 有关此属性的描述，请参阅 [getPicturePosition()](../../com.aspose.diagram/checkboxactivexcontrol\#getPicturePosition--) |
| [setSpecialEffect(int value)](#setSpecialEffect-int-) | 有关此属性的描述，请参阅 [getSpecialEffect()](../../com.aspose.diagram/checkboxactivexcontrol\#getSpecialEffect--) |
...
| [setTripleState(boolean value)](#setTripleState-boolean-) | 有关此属性的描述，请参阅 [isTripleState()](../../com.aspose.diagram/checkboxactivexcontrol\#isTripleState--) |
| [setValue(int value)](#setValue-int-) | 有关此属性的描述，请参阅 [getValue()](../../com.aspose.diagram/checkboxactivexcontrol\#getValue--) |
| [setWidth(double value)](#setWidth-double-) | 有关此属性的描述，请参阅 [getWidth()](../../com.aspose.diagram/activexcontrolbase\#getWidth--) |
| [setWordWrapped(boolean value)](#setWordWrapped-boolean-) | 有关此属性的描述，请参阅 [isWordWrapped()](../../com.aspose.diagram/checkboxactivexcontrol\#isWordWrapped--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
有关此属性的描述，请参阅 [getAccelerator()](../../com.aspose.diagram/checkboxactivexcontrol\#getAccelerator--)
...
有关此属性的描述，请参阅 [getAlignment()](../../com.aspose.diagram/checkboxactivexcontrol\#getAlignment--)
...
有关此属性的描述，请参阅 [getCaption()](../../com.aspose.diagram/checkboxactivexcontrol\#getCaption--)
...
有关此属性的描述，请参阅 [isChecked()](../../com.aspose.diagram/checkboxactivexcontrol\#isChecked--)
...
有关此属性的描述，请参阅 [getGroupName()](../../com.aspose.diagram/checkboxactivexcontrol\#getGroupName--)
...
有关此属性的描述，请参阅 [getPicture()](../../com.aspose.diagram/checkboxactivexcontrol\#getPicture--)
...
有关此属性的描述，请参阅 [getPicturePosition()](../../com.aspose.diagram/checkboxactivexcontrol\#getPicturePosition--)
...
有关此属性的描述，请参阅 [getSpecialEffect()](../../com.aspose.diagram/checkboxactivexcontrol\#getSpecialEffect--)
...
有关此属性的描述，请参阅 [isTripleState()](../../com.aspose.diagram/checkboxactivexcontrol\#isTripleState--)
...
有关此属性的描述，请参阅 [getValue()](../../com.aspose.diagram/checkboxactivexcontrol\#getValue--)
...
有关此属性的描述，请参阅 [isWordWrapped()](../../com.aspose.diagram/checkboxactivexcontrol\#isWordWrapped--)
