...
description: 表示可在 3D 中应用于形状的斜角类型的预设。
type: docs
weight: 35
url: /zh/java/com.aspose.diagram/bevelpresettype/
---
...
表示可在 3D 中应用于形状的斜角类型的预设。
## 字段

| 字段 | 描述 |
| --- | --- |
| [ANGLE](#ANGLE) | 角度 |
| [ART_DECO](#ART-DECO) | 艺术装饰风格 |
| [CIRCLE](#CIRCLE) | 圆形 |
| [CONVEX](#CONVEX) | 凸面 |
| [COOL_SLANT](#COOL-SLANT) | 酷斜体 |
| [CROSS](#CROSS) | 十字 |
| [DIVOT](#DIVOT) | 凹痕 |
| [HARD_EDGE](#HARD-EDGE) | 硬边 |
| [NONE](#NONE) | 无斜角 |
| [RELAXED_INSET](#RELAXED-INSET) | 放松的内嵌 |
| [RIBLET](#RIBLET) | 肋条 |
| [SLOPE](#SLOPE) | 斜坡 |
| [SOFT_ROUND](#SOFT-ROUND) | 柔和圆形 |
## 方法
