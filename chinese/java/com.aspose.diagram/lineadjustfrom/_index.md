...
description: 指定在动态连接器相互重叠时需要分开的连接器。
type: docs
weight: 222
url: /zh/java/com.aspose.diagram/lineadjustfrom/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [LineAdjustFrom(int value)](#LineAdjustFrom-int-) | 构造函数。 |
## 方法
...
| [getValue()](#getValue--) | 指定在动态连接器相互重叠时需要分开的连接器。 |
