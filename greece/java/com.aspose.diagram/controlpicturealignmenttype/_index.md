...
description: Αντιπροσωπεύει την ευθυγράμμιση της εικόνας μέσα στη Φόρμα ή στην Εικόνα.
type: docs
weight: 94
url: /el/java/com.aspose.diagram/controlpicturealignmenttype/
---
...
Αντιπροσωπεύει την ευθυγράμμιση της εικόνας μέσα στη Φόρμα ή στην Εικόνα.
## Πεδία
