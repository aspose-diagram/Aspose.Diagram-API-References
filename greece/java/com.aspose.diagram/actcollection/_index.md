...
description: Συλλογή Act.
type: docs
weight: 12
url: /el/java/com.aspose.diagram/actcollection/
---
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [add(Act item)](#add-com.aspose.diagram.Act-) | Προσθέστε το αντικείμενο Act στη συλλογή. |
| [clear()](#clear--) | Removes all elements from collection. |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [get(int index)](#get-int-) | Gets the element at the specified index. |
| [getAct(int ID)](#getAct-int-) | Λαμβάνει το στοιχείο με το καθορισμένο ID. |
| [getClass()](#getClass--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Act item)](#remove-com.aspose.diagram.Act-) | Αφαιρέστε το αντικείμενο Act από τη συλλογή. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
