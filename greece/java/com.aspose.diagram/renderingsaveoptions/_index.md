...
type: docs
weight: 327
url: /el/java/com.aspose.diagram/renderingsaveoptions/
---
...
Αυτή είναι μια αφηρημένη βασική κλάση για κλάσεις που επιτρέπουν στον χρήστη να καθορίσει πρόσθετες επιλογές κατά την αποθήκευση ενός διαγράμματος σε συγκεκριμένη μορφή.
## Μέθοδοι
