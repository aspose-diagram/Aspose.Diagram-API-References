...
type: docs
weight: 424
url: /el/java/com.aspose.diagram/unknowncontrol/
---
...
| [getPersistenceType()](#getPersistenceType--) | Λαμβάνει τη μέθοδο διατήρησης για τη διατήρηση ενός ελέγχου ActiveX. |
| [getRelationshipData(String relId)](#getRelationshipData-java.lang.String-) | Λαμβάνει τα δεδομένα της σχέσης. |
...
Λαμβάνει τη μέθοδο διατήρησης για τη διατήρηση ενός ελέγχου ActiveX.
...
Λαμβάνει τα δεδομένα της σχέσης.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| relId | java.lang.String | Το αναγνωριστικό της σχέσης. |

**Returns:**
byte[] - επιστρέφει τα δεδομένα της σχέσης.
### getType() {#getType--}
```
public int getType()
```
