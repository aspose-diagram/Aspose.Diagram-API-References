...
description: Αντιπροσωπεύει έναν έλεγχο CheckBox ActiveX.
type: docs
weight: 47
url: /el/java/com.aspose.diagram/checkboxactivexcontrol/
---
...
Αντιπροσωπεύει έναν έλεγχο CheckBox ActiveX.
## Μέθοδοι
...
| [getAlignment()](#getAlignment--) | η θέση του Caption σε σχέση με τον έλεγχο. |
...
| [getGroupName()](#getGroupName--) | το όνομα της ομάδας. |
...
| [isChecked()](#isChecked--) | Δείχνει αν το πλαίσιο είναι επιλεγμένο. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAccelerator(char value)](#setAccelerator-char-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getAccelerator()](../../com.aspose.diagram/checkboxactivexcontrol\\#getAccelerator--) |
| [setAlignment(int value)](#setAlignment-int-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getAlignment()](../../com.aspose.diagram/checkboxactivexcontrol\\#getAlignment--) |
...
| [setCaption(String value)](#setCaption-java.lang.String-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getCaption()](../../com.aspose.diagram/checkboxactivexcontrol\\#getCaption--) |
| [setChecked(boolean value)](#setChecked-boolean-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [isChecked()](../../com.aspose.diagram/checkboxactivexcontrol\\#isChecked--) |
...
| [setGroupName(String value)](#setGroupName-java.lang.String-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getGroupName()](../../com.aspose.diagram/checkboxactivexcontrol\\#getGroupName--) |
...
| [setPicture(byte[] value)](#setPicture-byte---) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getPicture()](../../com.aspose.diagram/checkboxactivexcontrol\\#getPicture--) |
| [setPicturePosition(int value)](#setPicturePosition-int-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getPicturePosition()](../../com.aspose.diagram/checkboxactivexcontrol\\#getPicturePosition--) |
| [setSpecialEffect(int value)](#setSpecialEffect-int-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getSpecialEffect()](../../com.aspose.diagram/checkboxactivexcontrol\\#getSpecialEffect--) |
...
| [setTripleState(boolean value)](#setTripleState-boolean-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [isTripleState()](../../com.aspose.diagram/checkboxactivexcontrol\\#isTripleState--) |
| [setValue(int value)](#setValue-int-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getValue()](../../com.aspose.diagram/checkboxactivexcontrol\\#getValue--) |
...
| [setWordWrapped(boolean value)](#setWordWrapped-boolean-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [isWordWrapped()](../../com.aspose.diagram/checkboxactivexcontrol\\#isWordWrapped--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
η θέση του Caption σε σχέση με τον έλεγχο.
...
Δείχνει αν το πλαίσιο είναι επιλεγμένο.
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getAccelerator()](../../com.aspose.diagram/checkboxactivexcontrol\\#getAccelerator--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getAlignment()](../../com.aspose.diagram/checkboxactivexcontrol\\#getAlignment--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getCaption()](../../com.aspose.diagram/checkboxactivexcontrol\\#getCaption--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [isChecked()](../../com.aspose.diagram/checkboxactivexcontrol\\#isChecked--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getGroupName()](../../com.aspose.diagram/checkboxactivexcontrol\\#getGroupName--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getPicture()](../../com.aspose.diagram/checkboxactivexcontrol\\#getPicture--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getPicturePosition()](../../com.aspose.diagram/checkboxactivexcontrol\\#getPicturePosition--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getSpecialEffect()](../../com.aspose.diagram/checkboxactivexcontrol\\#getSpecialEffect--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [isTripleState()](../../com.aspose.diagram/checkboxactivexcontrol\\#isTripleState--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getValue()](../../com.aspose.diagram/checkboxactivexcontrol\\#getValue--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [isWordWrapped()](../../com.aspose.diagram/checkboxactivexcontrol\\#isWordWrapped--)
