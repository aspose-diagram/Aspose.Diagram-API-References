...
description: Αντιπροσωπεύει ένα προεπιλεγμένο φως δεξιά που μπορεί να εφαρμοστεί σε ένα σχήμα
type: docs
weight: 32
url: /el/java/com.aspose.diagram/bevellightingtypevalue/
---
...
Αντιπροσωπεύει ένα προεπιλεγμένο φως δεξιά που μπορεί να εφαρμοστεί σε ένα σχήμα
## Πεδία
...
| [SOFT](#SOFT) | Μαλακό |
| [SUNRISE](#SUNRISE) | Ανατολή |
| [SUNSET](#SUNSET) | Ηλιοβασίλεμα |
| [THREE_POINT](#THREE-POINT) | Τρία σημεία |
| [TWO_POINT](#TWO-POINT) | Δύο σημεία |
| [UNDEFINED](#UNDEFINED) | Χωρίς φωτιστικό σύστημα. |
## Μέθοδοι
