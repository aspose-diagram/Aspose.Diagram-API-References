...
type: docs
weight: 80
url: /el/java/com.aspose.diagram/connectionabcdcollection/
---
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [add(ConnectionABCD item)](#add-com.aspose.diagram.ConnectionABCD-) | Προσθέστε το αντικείμενο ConnectionABCD στη συλλογή. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(ConnectionABCD item)](#remove-com.aspose.diagram.ConnectionABCD-) | Αφαιρέστε το αντικείμενο ConnectionABCD από τη συλλογή. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
