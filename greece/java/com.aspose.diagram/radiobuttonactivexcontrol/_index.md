...
description: Αναπαριστά έναν έλεγχο RadioButton ActiveX.
type: docs
weight: 313
url: /el/java/com.aspose.diagram/radiobuttonactivexcontrol/
---
...
Αναπαριστά έναν έλεγχο RadioButton ActiveX.
## Μέθοδοι
...
| [setAlignment(int value)](#setAlignment-int-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getAlignment()](../../com.aspose.diagram/radiobuttonactivexcontrol\#getAlignment--) |
...
| [setGroupName(String value)](#setGroupName-java.lang.String-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getGroupName()](../../com.aspose.diagram/radiobuttonactivexcontrol\#getGroupName--) |
...
| [setWordWrapped(boolean value)](#setWordWrapped-boolean-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [isWordWrapped()](../../com.aspose.diagram/radiobuttonactivexcontrol\#isWordWrapped--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getAlignment()](../../com.aspose.diagram/radiobuttonactivexcontrol\#getAlignment--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getGroupName()](../../com.aspose.diagram/radiobuttonactivexcontrol\#getGroupName--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [isWordWrapped()](../../com.aspose.diagram/radiobuttonactivexcontrol\#isWordWrapped--)
