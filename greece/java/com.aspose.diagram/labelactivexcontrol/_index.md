...
description: Αναπαριστά τον έλεγχο ActiveX ετικέτας.
type: docs
weight: 211
url: /el/java/com.aspose.diagram/labelactivexcontrol/
---
...
Αναπαριστά τον έλεγχο ActiveX ετικέτας.
## Μέθοδοι
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAccelerator(char value)](#setAccelerator-char-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getAccelerator()](../../com.aspose.diagram/labelactivexcontrol\#getAccelerator--) |
...
| [setBorderOleColor(int value)](#setBorderOleColor-int-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getBorderOleColor()](../../com.aspose.diagram/labelactivexcontrol\#getBorderOleColor--) |
| [setBorderStyle(int value)](#setBorderStyle-int-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getBorderStyle()](../../com.aspose.diagram/labelactivexcontrol\#getBorderStyle--) |
| [setCaption(String value)](#setCaption-java.lang.String-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getCaption()](../../com.aspose.diagram/labelactivexcontrol\#getCaption--) |
...
| [setPicture(byte[] value)](#setPicture-byte---) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getPicture()](../../com.aspose.diagram/labelactivexcontrol\#getPicture--) |
| [setPicturePosition(int value)](#setPicturePosition-int-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getPicturePosition()](../../com.aspose.diagram/labelactivexcontrol\#getPicturePosition--) |
| [setSpecialEffect(int value)](#setSpecialEffect-int-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getSpecialEffect()](../../com.aspose.diagram/labelactivexcontrol\#getSpecialEffect--) |
...
| [setWordWrapped(boolean value)](#setWordWrapped-boolean-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [isWordWrapped()](../../com.aspose.diagram/labelactivexcontrol\#isWordWrapped--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getAccelerator()](../../com.aspose.diagram/labelactivexcontrol\#getAccelerator--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getBorderOleColor()](../../com.aspose.diagram/labelactivexcontrol\#getBorderOleColor--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getBorderStyle()](../../com.aspose.diagram/labelactivexcontrol\#getBorderStyle--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getCaption()](../../com.aspose.diagram/labelactivexcontrol\#getCaption--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getPicture()](../../com.aspose.diagram/labelactivexcontrol\#getPicture--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getPicturePosition()](../../com.aspose.diagram/labelactivexcontrol\#getPicturePosition--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getSpecialEffect()](../../com.aspose.diagram/labelactivexcontrol\#getSpecialEffect--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [isWordWrapped()](../../com.aspose.diagram/labelactivexcontrol\#isWordWrapped--)
