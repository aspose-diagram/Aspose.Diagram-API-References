...
description: Αναπαριστά τον έλεγχο εικόνας.
type: docs
weight: 197
url: /el/java/com.aspose.diagram/imageactivexcontrol/
---
...
| [getPictureAlignment()](#getPictureAlignment--) | η στοίχιση της εικόνας μέσα στη Φόρμα ή στην Εικόνα. |
| [getPictureSizeMode()](#getPictureSizeMode--) | πώς να εμφανίσετε την εικόνα. |
...
| [isTiled()](#isTiled--) | Δείχνει εάν η εικόνα είναι επαναλαμβανόμενη στο φόντο. |
| [isTransparent()](#isTransparent--) | Δείχνει αν ο έλεγχος είναι διαφανής. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAutoSize(boolean value)](#setAutoSize-boolean-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλούμε δείτε [isAutoSize()](../../com.aspose.diagram/imageactivexcontrol\#isAutoSize--) |
...
| [setBorderOleColor(int value)](#setBorderOleColor-int-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλούμε δείτε [getBorderOleColor()](../../com.aspose.diagram/imageactivexcontrol\#getBorderOleColor--) |
| [setBorderStyle(int value)](#setBorderStyle-int-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλούμε δείτε [getBorderStyle()](../../com.aspose.diagram/imageactivexcontrol\#getBorderStyle--) |
...
| [setPicture(byte[] value)](#setPicture-byte---) | Για την περιγραφή αυτής της ιδιότητας, παρακαλούμε δείτε [getPicture()](../../com.aspose.diagram/imageactivexcontrol\#getPicture--) |
| [setPictureAlignment(int value)](#setPictureAlignment-int-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getPictureAlignment()](../../com.aspose.diagram/imageactivexcontrol\#getPictureAlignment--) |
| [setPictureSizeMode(int value)](#setPictureSizeMode-int-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getPictureSizeMode()](../../com.aspose.diagram/imageactivexcontrol\#getPictureSizeMode--) |
| [setSpecialEffect(int value)](#setSpecialEffect-int-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getSpecialEffect()](../../com.aspose.diagram/imageactivexcontrol\#getSpecialEffect--) |
| [setTiled(boolean value)](#setTiled-boolean-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [isTiled()](../../com.aspose.diagram/imageactivexcontrol\#isTiled--) |
...
η στοίχιση της εικόνας μέσα στη Φόρμα ή στην Εικόνα.
...
Δείχνει εάν η εικόνα είναι επαναλαμβανόμενη στο φόντο.
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλούμε δείτε [isAutoSize()](../../com.aspose.diagram/imageactivexcontrol\#isAutoSize--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλούμε δείτε [getBorderOleColor()](../../com.aspose.diagram/imageactivexcontrol\#getBorderOleColor--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλούμε δείτε [getBorderStyle()](../../com.aspose.diagram/imageactivexcontrol\#getBorderStyle--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλούμε δείτε [getPicture()](../../com.aspose.diagram/imageactivexcontrol\#getPicture--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getPictureAlignment()](../../com.aspose.diagram/imageactivexcontrol\#getPictureAlignment--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getPictureSizeMode()](../../com.aspose.diagram/imageactivexcontrol\#getPictureSizeMode--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getSpecialEffect()](../../com.aspose.diagram/imageactivexcontrol\#getSpecialEffect--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [isTiled()](../../com.aspose.diagram/imageactivexcontrol\#isTiled--)
