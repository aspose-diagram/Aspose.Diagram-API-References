...
description: Καθορίζει εάν τα αντικείμενα είναι τοποθετήσιμα ή δρομολογήσιμα σε διαγράμματα όταν χρησιμοποιείτε το Microsoft Visio για τη διάταξη σχημάτων στη σελίδα σχεδίασης.
type: docs
weight: 252
url: /el/java/com.aspose.diagram/objtype/
---
...
| --- | --- |
| [ObjType(int value)](#ObjType-int-) | Κατασκευαστής. |
## Μέθοδοι
...
| [getValue()](#getValue--) | Καθορίζει εάν τα αντικείμενα είναι τοποθετήσιμα ή δρομολογήσιμα σε διαγράμματα όταν χρησιμοποιείτε το Microsoft Visio για τη διάταξη σχημάτων στη σελίδα σχεδίασης. |
