...
description: Καθορίζει ποιοι δυναμικοί συνδέσμοι να διαχωριστούν εάν δρομολογηθούν πάνω ο ένας στον άλλο.
type: docs
weight: 223
url: /el/java/com.aspose.diagram/lineadjustfromvalue/
---
...
| Πεδίο | Περιγραφή |
| --- | --- |
| [ALL_LINES](#ALL-LINES) | Όλες οι γραμμές. |
| [NO_LINES](#NO-LINES) | Καμία γραμμή. |
| [ROUTING_STYLE_DEFAULT](#ROUTING-STYLE-DEFAULT) | Προεπιλογή στυλ δρομολόγησης. |
| [UNDEFINED](#UNDEFINED) | Απροσδιόριστο. |
| [UNRELATED_LINES](#UNRELATED-LINES) | Ασχετικές γραμμές. |
## Μέθοδοι
