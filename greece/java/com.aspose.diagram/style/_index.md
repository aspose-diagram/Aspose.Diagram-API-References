...
type: docs
weight: 391
url: /el/java/com.aspose.diagram/style/
---
...
| --- | --- |
| [Style(int value)](#Style-int-) | Κατασκευαστής. |
## Μέθοδοι
...
| [getValue()](#getValue--) | Καθορίζει τη μορφοποίηση χαρακτήρων που εφαρμόζεται σε μια περιοχή κειμένου στο μπλοκ κειμένου του σχήματος. |
