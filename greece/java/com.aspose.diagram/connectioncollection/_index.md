...
type: docs
weight: 81
url: /el/java/com.aspose.diagram/connectioncollection/
---
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [add(Connection item)](#add-com.aspose.diagram.Connection-) | Προσθέστε το αντικείμενο Connection στη συλλογή. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Connection item)](#remove-com.aspose.diagram.Connection-) | Αφαιρέστε το αντικείμενο Connection από τη συλλογή. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Προσθέστε το αντικείμενο Connection στη συλλογή.
...
Αφαιρέστε το αντικείμενο Connection από τη συλλογή.
