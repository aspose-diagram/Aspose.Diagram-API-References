...
description: Αντιπροσωπεύει τον έλεγχο ScrollBar.
type: docs
weight: 352
url: /el/java/com.aspose.diagram/scrollbaractivexcontrol/
---
...
Αντιπροσωπεύει τον έλεγχο ScrollBar.
## Μέθοδοι
...
| [getLargeChange()](#getLargeChange--) | το ποσό κατά το οποίο αλλάζει η ιδιότητα Position |
| [getMax()](#getMax--) | η μέγιστη αποδεκτή τιμή. |
| [getMin()](#getMin--) | η ελάχιστη αποδεκτή τιμή. |
...
| [getOrientation()](#getOrientation--) | αν το SpinButton ή το ScrollBar είναι προσανατολισμένο κάθετα ή οριζόντια. |
| [getPosition()](#getPosition--) | η τιμή. |
| [getSmallChange()](#getSmallChange--) | το ποσό κατά το οποίο αλλάζει η ιδιότητα Position |
...
| [setLargeChange(int value)](#setLargeChange-int-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getLargeChange()](../../com.aspose.diagram/scrollbaractivexcontrol\#getLargeChange--) |
...
| [setMax(int value)](#setMax-int-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getMax()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getMax--) |
| [setMin(int value)](#setMin-int-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getMin()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getMin--) |
...
| [setOrientation(int value)](#setOrientation-int-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getOrientation()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getOrientation--) |
| [setPosition(int value)](#setPosition-int-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getPosition()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getPosition--) |
| [setSmallChange(int value)](#setSmallChange-int-) | Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getSmallChange()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getSmallChange--) |
...
το ποσό κατά το οποίο αλλάζει η ιδιότητα Position
...
αν το SpinButton ή το ScrollBar είναι προσανατολισμένο κάθετα ή οριζόντια.
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getLargeChange()](../../com.aspose.diagram/scrollbaractivexcontrol\#getLargeChange--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getMax()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getMax--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getMin()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getMin--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getOrientation()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getOrientation--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getPosition()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getPosition--)
...
Για την περιγραφή αυτής της ιδιότητας, παρακαλώ δείτε [getSmallChange()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getSmallChange--)
