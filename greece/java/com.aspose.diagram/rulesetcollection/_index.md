...
type: docs
weight: 342
url: /el/java/com.aspose.diagram/rulesetcollection/
---
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [add(RuleSet ruleSet)](#add-com.aspose.diagram.RuleSet-) | Προσθέστε το ruleSet στη συλλογή. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(RuleSet ruleSet)](#remove-com.aspose.diagram.RuleSet-) | Αφαιρέστε το ruleSet από τη συλλογή. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Προσθέστε το ruleSet στη συλλογή.
...
Αφαιρέστε το ruleSet από τη συλλογή.
