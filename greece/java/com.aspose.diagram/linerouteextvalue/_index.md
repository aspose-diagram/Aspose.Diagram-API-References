...
description: Καθορίζει την προεπιλεγμένη εμφάνιση για όλους τους συνδέσμους σε μια σελίδα.
type: docs
weight: 231
url: /el/java/com.aspose.diagram/linerouteextvalue/
---
...
| Πεδίο | Περιγραφή |
| --- | --- |
| [CURVED](#CURVED) | Καμπυλωτό. |
| [DEFAULT](#DEFAULT) | Default. |
| [STRAIGHT](#STRAIGHT) | Ευθύ. |
