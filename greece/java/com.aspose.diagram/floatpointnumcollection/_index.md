...
description: Περιέχει μια συλλογή αριθμών σημείων διπλασιασμού
type: docs
weight: 156
url: /el/java/com.aspose.diagram/floatpointnumcollection/
---
...
Περιέχει μια συλλογή αριθμών σημείων διπλασιασμού
## Κατασκευαστές
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [add(double number)](#add-double-) | Προσθέστε τον αριθμό διπλασιασμού σημείου στη συλλογή. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(double number)](#remove-double-) | Αφαιρέστε τον αριθμό διπλασιασμού σημείου από τη συλλογή. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Προσθέστε τον αριθμό διπλασιασμού σημείου στη συλλογή.
...
Αφαιρέστε τον αριθμό διπλασιασμού σημείου από τη συλλογή.
