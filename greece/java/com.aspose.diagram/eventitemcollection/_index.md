...
description: Συλλογή EventItem.
type: docs
weight: 146
url: /el/java/com.aspose.diagram/eventitemcollection/
---
...
| --- | --- |
| [EventItemCollection()](#EventItemCollection--) | Κατασκευαστής. |
## Μέθοδοι

| Μέθοδος | Περιγραφή |
| --- | --- |
| [add(EventItem eventItem)](#add-com.aspose.diagram.EventItem-) | Προσθέστε το eventItem στη συλλογή. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(EventItem eventItem)](#remove-com.aspose.diagram.EventItem-) | Αφαιρέστε το eventItem από τη συλλογή. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
