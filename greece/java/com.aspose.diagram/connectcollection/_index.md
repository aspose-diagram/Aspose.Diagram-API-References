...
type: docs
weight: 76
url: /el/java/com.aspose.diagram/connectcollection/
---
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [add(Connect connect)](#add-com.aspose.diagram.Connect-) | Προσθέστε το connect στη συλλογή. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Connect connect)](#remove-com.aspose.diagram.Connect-) | Αφαιρέστε το connect από τη συλλογή. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Προσθέστε το connect στη συλλογή.
...
Αφαιρέστε το connect από τη συλλογή.
