...
description: Αναπαριστούν διαφορετικές αλγοριθμικές μεθόδους για τον καθορισμό όλων των ιδιοτήτων της κάμερας, συμπεριλαμβανομένης της θέσης.
type: docs
weight: 296
url: /el/java/com.aspose.diagram/presetcameratype/
---
...
Αναπαριστά διαφορετικές αλγοριθμικές μεθόδους για τον ορισμό όλων των ιδιοτήτων της κάμερας, συμπεριλαμβανομένης της θέσης.
## Πεδία
