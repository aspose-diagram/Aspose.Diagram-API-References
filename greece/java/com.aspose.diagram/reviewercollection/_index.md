...
description: Συλλογή Reviewer.
type: docs
weight: 331
url: /el/java/com.aspose.diagram/reviewercollection/
---
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [add(Reviewer item)](#add-com.aspose.diagram.Reviewer-) | Προσθέστε το αντικείμενο Reviewer στη συλλογή. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Reviewer item)](#remove-com.aspose.diagram.Reviewer-) | Αφαιρέστε το αντικείμενο Reviewer από τη συλλογή. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
