...
description: Συλλογή παραγράφων.
type: docs
weight: 275
url: /el/java/com.aspose.diagram/paracollection/
---
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [add(Para item)](#add-com.aspose.diagram.Para-) | Προσθέστε το αντικείμενο Para στη συλλογή. |
| [clear()](#clear--) | Removes all elements from collection. |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [get(int index)](#get-int-) | Gets the element at the specified index. |
| [getClass()](#getClass--) |  |
| [getCount()](#getCount--) | Gets the number of elements actually contained in the collection. |
| [getPara(int IX)](#getPara-int-) | Αποκτά το στοιχείο στον καθορισμένο δείκτη IX. |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Para item)](#remove-com.aspose.diagram.Para-) | Αφαιρέστε το αντικείμενο Para από τη συλλογή. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Αποκτά το στοιχείο στον καθορισμένο δείκτη IX. Επιστρέφει Null εάν το στοιχείο δεν υπάρχει.
