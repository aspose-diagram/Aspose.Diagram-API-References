...
description: Συλλογή ζητημάτων.
type: docs
weight: 209
url: /el/java/com.aspose.diagram/issuecollection/
---
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [add(Issue issue)](#add-com.aspose.diagram.Issue-) | Προσθέστε το ζήτημα στη συλλογή. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Issue issue)](#remove-com.aspose.diagram.Issue-) | Αφαιρέστε το ζήτημα από τη συλλογή. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Προσθέστε το ζήτημα στη συλλογή.
