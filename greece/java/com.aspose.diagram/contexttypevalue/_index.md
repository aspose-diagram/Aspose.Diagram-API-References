...
description: Καθορίζει τις ιδιότητες της ομάδας ή του σχήματος που θα χρησιμοποιηθούν για τη σύγκριση.
type: docs
weight: 86
url: /el/java/com.aspose.diagram/contexttypevalue/
---
...
Καθορίζει τις ιδιότητες της ομάδας ή του σχήματος που θα χρησιμοποιηθούν για τη σύγκριση. Οι πιθανές τιμές εμφανίζονται στον παρακάτω πίνακα.
## Πεδία
...
| [DATA_2](#DATA-2) | Data2. |
| [DATA_3](#DATA-3) | Data3. |
| [GEOMETRY_ANGLE](#GEOMETRY-ANGLE) | Γωνία γεωμετρίας. |
| [GEOMETRY_HEIGHT](#GEOMETRY-HEIGHT) | Ύψος γεωμετρίας. |
