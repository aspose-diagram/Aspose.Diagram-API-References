...
description: Περιέχει μια συλλογή στοιχείων Font.
type: docs
weight: 159
url: /el/java/com.aspose.diagram/fontcollection/
---
...
| [getFont(int ID)](#getFont-int-) | Λαμβάνει το στοιχείο με το καθορισμένο ID. |
| [hashCode()](#hashCode--) |  |
