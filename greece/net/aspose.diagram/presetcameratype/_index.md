...
description: Αντιπροσωπεύουν διαφορετικές αλγοριθμικές μεθόδους για τη ρύθμιση όλων των ιδιοτήτων της κάμερας συμπεριλαμβανομένης της θέσης.
type: docs
weight: 2720
url: /el/net/aspose.diagram/presetcameratype/
---
