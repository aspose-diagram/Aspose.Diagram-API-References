...
type: docs
weight: 3130
url: /ja/net/aspose.diagram/rulecollection/
---
...
| [Item](../../aspose.diagram/rulecollection/item/) { get; } | 指定されたインデックスの要素を取得します。 |

## メソッド

| 名前 | 説明 |
| --- | --- |
| [Add](../../aspose.diagram/rulecollection/add/)(Rule) | コレクションにルールを追加します。 |
...
| [Remove](../../aspose.diagram/rulecollection/remove/)(Rule) | コレクションからルールを削除します。 |
