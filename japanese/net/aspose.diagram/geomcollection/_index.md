...
type: docs
weight: 1670
url: /ja/net/aspose.diagram/geomcollection/
---
...
| [Item](../../aspose.diagram/geomcollection/item/) { get; } | 指定されたインデックスの要素を取得します。 |

## メソッド

| 名前 | 説明 |
| --- | --- |
| [Add](../../aspose.diagram/geomcollection/add/)(Geom) | コレクションに Geom オブジェクトを追加します。 |
...
| [Remove](../../aspose.diagram/geomcollection/remove/)(Geom) | コレクションから Geom オブジェクトを削除します。 |
