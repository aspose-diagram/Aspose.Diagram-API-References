...
description: EllipticalArcTo コレクション
type: docs
weight: 1390
url: /ja/net/aspose.diagram/ellipticalarctocollection/
---
## EllipticalArcToCollection class

EllipticalArcTo コレクション。
...
| [Item](../../aspose.diagram/ellipticalarctocollection/item/) { get; } | 指定されたインデックスの要素を取得します。 |
