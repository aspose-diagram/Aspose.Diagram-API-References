...
type: docs
weight: 1900
url: /ja/net/aspose.diagram/hyperlinkcollection/
---
...
| [Item](../../aspose.diagram/hyperlinkcollection/item/) { get; } | 指定されたインデックスの要素を取得します。 |

## メソッド

| 名前 | 説明 |
| --- | --- |
| [Add](../../aspose.diagram/hyperlinkcollection/add/)(Hyperlink) | コレクションに Hyperlink オブジェクトを追加します。 |
...
| [Remove](../../aspose.diagram/hyperlinkcollection/remove/)(Hyperlink) | コレクションから Hyperlink オブジェクトを削除します。 |
