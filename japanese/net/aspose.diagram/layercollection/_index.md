...
description: レイヤー コレクション
type: docs
weight: 2030
url: /ja/net/aspose.diagram/layercollection/
---
...
| [Item](../../aspose.diagram/layercollection/item/) { get; } | 指定されたインデックスの要素を取得します。 |

## メソッド

| 名前 | 説明 |
| --- | --- |
| [Add](../../aspose.diagram/layercollection/add/)(Layer) | コレクションに Layer オブジェクトを追加します。 |
...
| [Remove](../../aspose.diagram/layercollection/remove/)(Layer) | コレクションから Layer オブジェクトを削除します。 |
