...
type: docs
weight: 1450
url: /ja/net/aspose.diagram/fieldcollection/
---
...
| [Item](../../aspose.diagram/fieldcollection/item/) { get; } | 指定されたインデックスの要素を取得します。 |

## メソッド

| 名前 | 説明 |
| --- | --- |
| [Add](../../aspose.diagram/fieldcollection/add/)(Field) | コレクションに Field オブジェクトを追加します。 |
...
| [Remove](../../aspose.diagram/fieldcollection/remove/)(Field) | コレクションから Field オブジェクトを削除します。 |
