...
type: docs
weight: 1080
url: /ja/net/aspose.diagram/custompropcollection/
---
...
| 名前 | 説明 |
| --- | --- |
| [CustomPropCollection](custompropcollection/)() | コンストラクター. |
...
| [Item](../../aspose.diagram/custompropcollection/item/) { get; } | 指定されたインデックスの要素を取得します。 |

## メソッド

| 名前 | 説明 |
| --- | --- |
| [Add](../../aspose.diagram/custompropcollection/add/)(CustomProp) | コレクションに CustomProp オブジェクトを追加します。 |
...
| [Remove](../../aspose.diagram/custompropcollection/remove/)(CustomProp) | コレクションから CustomProp オブジェクトを削除します。 |
