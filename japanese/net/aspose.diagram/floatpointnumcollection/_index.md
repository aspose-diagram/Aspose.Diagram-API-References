...
description: 倍加ポイント番号のコレクションが含まれています
type: docs
weight: 1530
url: /ja/net/aspose.diagram/floatpointnumcollection/
---
## FloatPointNumCollection class

倍加ポイント番号のコレクションが含まれています
...
| 名前 | 説明 |
| --- | --- |
| [FloatPointNumCollection](floatpointnumcollection/)() | コンストラクター. |
...
| [Item](../../aspose.diagram/floatpointnumcollection/item/) { get; } | 指定されたインデックスの要素を取得します。 |

## メソッド

| 名前 | 説明 |
| --- | --- |
| [Add](../../aspose.diagram/floatpointnumcollection/add/)(double) | コレクションに倍加ポイント数を追加します。 |
...
| [Remove](../../aspose.diagram/floatpointnumcollection/remove/)(double) | コレクションから倍加ポイント番号を削除します。 |
