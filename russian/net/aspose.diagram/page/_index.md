...
| [Background](../../aspose.diagram/page/background) { get; set; } | Флаг, указывающий, является ли страница фоновой. |
| [BackPage](../../aspose.diagram/page/backpage) { get; set; } | Фон страницы. |
...
| [PresetThemeQuickStyle](../../aspose.diagram/page/presetthemequickstyle) { set; } | Применить готовый вариант быстрой темы к этой странице |
...
| [ViewScale](../../aspose.diagram/page/viewscale) { get; set; } | Коэффициент увеличения по умолчанию, используемый при открытии нового вида (окна) страницы. Например, 1 = 100%; 1,5 = 150% и так далее. |
...
| [ApplyStyle](../../aspose.diagram/page/applystyle)(int, int, int) | Применяет стиль для полной страницы. |
| [AutoSpaceShapes](../../aspose.diagram/page/autospaceshapes)(ShapeCollection, AutoSpaceOptions) | Формы с автоматическим интервалом |
| [BringForward](../../aspose.diagram/page/bringforward)(long) | Переносит фигуру, определенную ID, на одну позицию вперед в z-порядке. |
| [BringToFront](../../aspose.diagram/page/bringtofront)(long) | Выводит фигуру, определенную ID, на передний план z-порядка. |
| [CenterDrawing](../../aspose.diagram/page/centerdrawing)() | Центрирует формы страницы относительно экстента страницы. Центрирование фигур не меняет их положение относительно друг друга. |
...
| [Dispose](../../aspose.diagram/page/dispose)() | Выполняет определяемые приложением задачи, связанные с освобождением, освобождением или сбросом неуправляемых ресурсов. |
...
| [DrawLine](../../aspose.diagram/page/drawline#drawline_1)(double, double, double, double, PointF[]) | Процесс рисования линии. |
| [DrawPolyline](../../aspose.diagram/page/drawpolyline)(double, double, double, double, PointF[]) | Процесс рисования полилинии. |
...
| [GlueShapes](../../aspose.diagram/page/glueshapes#glueshapes_1)(long, ConnectionPointPlace, long) | Склеивание фигур |
| [GlueShapes](../../aspose.diagram/page/glueshapes#glueshapes)(Shape, ConnectionPointPlace, Shape) | Склейте фигуры. |
...
| [GlueShapesInContainerByID](../../aspose.diagram/page/glueshapesincontainerbyid)(long, int, int, long) | Склеить фигуры по идентификатору соединения в контейнере |
...
| [GlueShapeToConnectorEndX](../../aspose.diagram/page/glueshapetoconnectorendx)(long, string, long) | Приклеить форму к EndX соединителя |
...
| [SendToBack](../../aspose.diagram/page/sendtoback)(long) | Перемещает фигуру, определенную ID, в конец z-порядка. |
