...
description: Указывает уникальный идентификатор фигуры связанной с родительской проблемой проверки. Если целью является документ или страница значение ShapeID может быть 0xFFFFFFFF.
type: docs
weight: 30
