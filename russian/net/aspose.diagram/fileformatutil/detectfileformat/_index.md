...
description: Обнаруживает и возвращает информацию о формате visio хранящегося в потоке.
type: docs
weight: 20
...
Обнаруживает и возвращает информацию о формате visio, хранящегося в потоке.
