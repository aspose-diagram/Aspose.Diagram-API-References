...
| [Diagram](diagram#constructor_1)(Stream) | PublicDiagramконструктор класса, загружает диаграмму из потока. |
| [Diagram](diagram#constructor_4)(string) | PublicDiagramконструктор класса, загружает диаграмму из файла. |
| [Diagram](diagram#constructor_2)(Stream, LoadFileFormat) | PublicDiagramконструктор класса, загружает диаграмму из потока в заранее заданном формате. |
| [Diagram](diagram#constructor_3)(Stream, LoadOptions) | PublicDiagramконструктор класса, загружает диаграмму из потока, используя предопределенные параметры загрузки файла . |
| [Diagram](diagram#constructor_5)(string, LoadFileFormat) | PublicDiagramконструктор класса, загружает диаграмму из файла в заранее заданном формате. |
| [Diagram](diagram#constructor_6)(string, LoadOptions) | PublicDiagramконструктор класса, загружает диаграмму из файла, используя предопределенные параметры загрузки файла . |
...
| [DocumentProps](../../aspose.diagram/diagram/documentprops) { get; } | Содержит элементы свойств документа, такие как заголовок документа, автор и т.д. |
| [DocumentSettings](../../aspose.diagram/diagram/documentsettings) { get; } | Содержит элементы, определяющие параметры документа. |
| [DocumentSheet](../../aspose.diagram/diagram/documentsheet) { get; } | Определяет структуру документа ShapeSheet. |
| [EmailRoutingData](../../aspose.diagram/diagram/emailroutingdata) { get; set; } | Содержит зашифрованную MIME (многоцелевое расширение почты Интернета) маршрутную накладную электронной почты MAPI для документа. |
...
| [FontDirs](../../aspose.diagram/diagram/fontdirs) { set; } | Указывает путь к папке Fonts |
| [Fonts](../../aspose.diagram/diagram/fonts) { get; } | Содержит набор элементов Font |
...
| [Start](../../aspose.diagram/diagram/start) { get; set; } | Указывает, был ли документ изменен вне Visio. Если присутствует, Visio полностью проверит содержимое файла. Не указывайте файлы, которые вы создаете вне Visio. |
| [StyleSheets](../../aspose.diagram/diagram/stylesheets) { get; } | Коллекция объектов StyleSheet. |
...
| [Validation](../../aspose.diagram/diagram/validation) { get; } | Хранит информацию о проверке диаграммы для документа. |
...
| [Windows](../../aspose.diagram/diagram/windows) { get; } | Содержит элементы Window для документа. |
...
| [AddMaster](../../aspose.diagram/diagram/addmaster#addmaster_2)(Stream, string) | Добавляет мастер на диаграмму из потока шаблонов по имени мастера или NameU. |
| [AddMaster](../../aspose.diagram/diagram/addmaster#addmaster_3)(string, int) | Добавляет мастера на диаграмму из файла шаблона по ID мастера. |
...
| [Combine](../../aspose.diagram/diagram/combine)(Diagram) | Объединяет другой объект Diagram. |
| [CopyTheme](../../aspose.diagram/diagram/copytheme)(Diagram) | Копирует тему из исходника Diagram. |
| [Dispose](../../aspose.diagram/diagram/dispose)() | Выполняет определяемые приложением задачи, связанные с освобождением, освобождением или сбросом неуправляемых ресурсов. |
| [GetDefaultFontDir](../../aspose.diagram/diagram/getdefaultfontdir)() | Получить путь к папке со шрифтами по умолчанию |
...
| [Layout](../../aspose.diagram/diagram/layout)(LayoutOptions) | Размещает формы и/или перенаправляет соединители для всех страниц схемы. |
| [Print](../../aspose.diagram/diagram/print#print)() | Печатает весь документ на принтер по умолчанию. |
...
| [Print](../../aspose.diagram/diagram/print#print_1)(PrintSaveOptions) | Печатает весь документ на принтер по умолчанию. |
...
| [Print](../../aspose.diagram/diagram/print#print_4)(PrinterSettings, string) | Печать документа в соответствии с заданными настройками принтера с использованием стандартного (без пользовательского интерфейса) контроллера печати и имени документа. |
...
| [Print](../../aspose.diagram/diagram/print#print_5)(PrinterSettings, string, PrintSaveOptions) | Печать документа в соответствии с заданными настройками принтера с использованием стандартного (без пользовательского интерфейса) контроллера печати и имени документа. |
...
| [Refresh](../../aspose.diagram/diagram/refresh)() | Вызывает метод Refresh для всех DataRecordSet на диаграмме. |
...
| static [Export](../../aspose.diagram/diagram/export#export_2)(string, Stream) | Экспортирует диаграмму из файла vsd в формат потока vdw. Еще не реализовано. |
