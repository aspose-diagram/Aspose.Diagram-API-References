...
description: Этот атрибут может присутствовать только в фигурах которые являются членами фигуры группы а группа является экземпляром мастера. Атрибут содержит идентификатор который ссылается на соответствующую подформу в мастере.
type: docs
weight: 420
