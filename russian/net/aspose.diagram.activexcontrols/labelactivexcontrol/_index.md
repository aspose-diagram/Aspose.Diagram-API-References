...
| [BorderOleColor](../../aspose.diagram.activexcontrols/labelactivexcontrol/borderolecolor/) { get; set; } | Получает и устанавливает цвет фона ole. |
...
| [IsWordWrapped](../../aspose.diagram.activexcontrols/labelactivexcontrol/iswordwrapped/) { get; set; } | Указывает, будет ли содержимое элемента управления автоматически переноситься в конце строки. |
