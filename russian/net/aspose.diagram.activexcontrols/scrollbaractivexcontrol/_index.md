...
| [Max](../../aspose.diagram.activexcontrols/spinbuttonactivexcontrol/max) { get; set; } | Получает и задает максимально допустимое значение. |
| [Min](../../aspose.diagram.activexcontrols/spinbuttonactivexcontrol/min) { get; set; } | Получает и задает минимально допустимое значение. |
...
| [Orientation](../../aspose.diagram.activexcontrols/spinbuttonactivexcontrol/orientation) { get; set; } | Получает и задает, ориентированы ли SpinButton или ScrollBar вертикально или горизонтально. |
