...
description: Определяет направление прыжка линии для прыжков линии, происходящих на вертикальном сегменте динамического соединителя.
type: docs
weight: 68
url: /ru/java/com.aspose.diagram/conlinejumpdiryvalue/
---
...
| --- | --- |
| [LEFT](#LEFT) | Слева. |
| [PAGE_DEFAULT](#PAGE-DEFAULT) | Страница по умолчанию. |
| [RIGHT](#RIGHT) | Справа. |
