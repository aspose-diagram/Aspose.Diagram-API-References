...
type: docs
weight: 424
url: /ru/java/com.aspose.diagram/unknowncontrol/
---
...
| [getPersistenceType()](#getPersistenceType--) | Получает метод сохранения для сохранения ActiveX‑контрола. |
| [getRelationshipData(String relId)](#getRelationshipData-java.lang.String-) | Получает данные связи. |
...
Получает метод сохранения для сохранения ActiveX‑контрола.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| relId | java.lang.String | Идентификатор связи. |

**Returns:**
byte[] — возвращает данные связи.
### getType() {#getType--}
```
public int getType()
```
