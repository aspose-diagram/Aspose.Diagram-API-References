...
description: Представляет режим выполнения по умолчанию редактора ввода Input Method Editor.
type: docs
weight: 204
url: /ru/java/com.aspose.diagram/inputmethodeditormode/
---
...
Представляет режим выполнения по умолчанию редактора ввода Input Method Editor.
## Поля
