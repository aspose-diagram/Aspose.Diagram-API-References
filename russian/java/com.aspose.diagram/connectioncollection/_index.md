...
description: Коллекция Connection.
type: docs
weight: 81
url: /ru/java/com.aspose.diagram/connectioncollection/
---
...
Коллекция Connection.
## Методы

| Метод | Описание |
| --- | --- |
| [add(Connection item)](#add-com.aspose.diagram.Connection-) | Добавить объект Connection в коллекцию. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Connection item)](#remove-com.aspose.diagram.Connection-) | Удалить объект Connection из коллекции. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
