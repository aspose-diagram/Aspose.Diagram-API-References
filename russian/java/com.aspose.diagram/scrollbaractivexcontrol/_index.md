...
type: docs
weight: 352
url: /ru/java/com.aspose.diagram/scrollbaractivexcontrol/
---
...
| [getLargeChange()](#getLargeChange--) | величина, на которую изменяется свойство Position |
| [getMax()](#getMax--) | максимально допустимое значение. |
| [getMin()](#getMin--) | минимально допустимое значение. |
...
| [getOrientation()](#getOrientation--) | является ли SpinButton или ScrollBar ориентирован вертикально или горизонтально. |
| [getPosition()](#getPosition--) | значение. |
| [getSmallChange()](#getSmallChange--) | величина, на которую изменяется свойство Position |
...
| [setLargeChange(int value)](#setLargeChange-int-) | Для описания этого свойства см. [getLargeChange()](../../com.aspose.diagram/scrollbaractivexcontrol\#getLargeChange--) |
...
| [setMax(int value)](#setMax-int-) | Для описания этого свойства см. [getMax()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getMax--) |
| [setMin(int value)](#setMin-int-) | Для описания этого свойства см. [getMin()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getMin--) |
...
| [setOrientation(int value)](#setOrientation-int-) | Для описания этого свойства см. [getOrientation()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getOrientation--) |
| [setPosition(int value)](#setPosition-int-) | Для описания этого свойства см. [getPosition()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getPosition--) |
| [setSmallChange(int value)](#setSmallChange-int-) | Для описания этого свойства см. [getSmallChange()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getSmallChange--) |
...
величина, на которую изменяется свойство Position
...
является ли SpinButton или ScrollBar ориентирован вертикально или горизонтально.
...
Для описания этого свойства см. [getLargeChange()](../../com.aspose.diagram/scrollbaractivexcontrol\#getLargeChange--)
...
Для описания этого свойства см. [getMax()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getMax--)
...
Для описания этого свойства см. [getMin()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getMin--)
...
Для описания этого свойства см. [getOrientation()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getOrientation--)
...
Для описания этого свойства см. [getPosition()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getPosition--)
...
Для описания этого свойства см. [getSmallChange()](../../com.aspose.diagram/spinbuttonactivexcontrol\#getSmallChange--)
