...
description: Определяет стиль прыжка линии для прыжков линии на динамическом соединителе.
type: docs
weight: 69
url: /ru/java/com.aspose.diagram/conlinejumpstyle/
---
...
| --- | --- |
| [ConLineJumpStyle(int value)](#ConLineJumpStyle-int-) | Конструктор. |
## Методы
...
| [getValue()](#getValue--) | Определяет стиль прыжка линии для прыжков линии на динамическом соединителе. |
| [hashCode()](#hashCode--) | Служит хеш‑функцией для конкретного типа. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setValue(int value)](#setValue-int-) | Для описания этого свойства, пожалуйста, см. [getValue()](../../com.aspose.diagram/conlinejumpstyle\#getValue--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Для описания этого свойства, пожалуйста, см. [getValue()](../../com.aspose.diagram/conlinejumpstyle\#getValue--)
