...
type: docs
weight: 33
url: /ru/java/com.aspose.diagram/bevelmaterialtype/
---
...
| --- | --- |
| [BevelMaterialType(int value)](#BevelMaterialType-int-) | Конструктор. |
## Методы
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setValue(int value)](#setValue-int-) | Для описания этого свойства, пожалуйста, см. [getValue()](../../com.aspose.diagram/bevelmaterialtype\#getValue--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Для описания этого свойства, пожалуйста, см. [getValue()](../../com.aspose.diagram/bevelmaterialtype\#getValue--)
