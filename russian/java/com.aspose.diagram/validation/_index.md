...
type: docs
weight: 427
url: /ru/java/com.aspose.diagram/validation/
---
...
| [getClass()](#getClass--) |  |
| [getIssues()](#getIssues--) | Содержит все элементы Issue для документа. |
| [getRuleSets()](#getRuleSets--) | Включает элемент RuleSet для каждого набора правил валидации в документе. |
| [getValidationProperties()](#getValidationProperties--) | Инкапсулирует свойства, связанные с проверкой документа. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [toString()](#toString--) |  |
...
Включает элемент RuleSet для каждого набора правил валидации в документе.
