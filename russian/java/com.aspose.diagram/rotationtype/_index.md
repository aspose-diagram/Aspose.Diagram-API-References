...
type: docs
weight: 332
url: /ru/java/com.aspose.diagram/rotationtype/
---
...
| --- | --- |
| [RotationType(int value)](#RotationType-int-) | Конструктор. |
## Методы
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setValue(int value)](#setValue-int-) | Для описания этого свойства, пожалуйста, см. [getValue()](../../com.aspose.diagram/rotationtype\#getValue--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Для описания этого свойства, пожалуйста, см. [getValue()](../../com.aspose.diagram/rotationtype\#getValue--)
