...
description: Определяет календарь, используемый для текстовых полей пользовательских свойств и формул элементов.
type: docs
weight: 42
url: /ru/java/com.aspose.diagram/calendarvalue/
---
