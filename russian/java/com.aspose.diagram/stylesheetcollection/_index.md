...
description: Коллекция таблиц стилей.
type: docs
weight: 394
url: /ru/java/com.aspose.diagram/stylesheetcollection/
---
...
Коллекция таблиц стилей.
## Методы

| Метод | Описание |
| --- | --- |
| [add(StyleSheet item)](#add-com.aspose.diagram.StyleSheet-) | Добавить StyleSheet в коллекцию. |
...
| [getStyleSheet(int ID)](#getStyleSheet-int-) | Получает элемент с указанным ID. |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(StyleSheet item)](#remove-com.aspose.diagram.StyleSheet-) | Удалить StyleSheet из коллекции. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Добавить StyleSheet в коллекцию.
...
Удалить StyleSheet из коллекции.
