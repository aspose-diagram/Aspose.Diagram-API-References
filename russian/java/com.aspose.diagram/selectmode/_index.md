...
description: Указывает, как пользователь выбирает группу фигур и её элементы.
type: docs
weight: 353
url: /ru/java/com.aspose.diagram/selectmode/
---
...
| --- | --- |
| [SelectMode(int value)](#SelectMode-int-) | Конструктор. |
## Методы
...
| [getValue()](#getValue--) | Указывает, как пользователь выбирает группу фигур и её элементы. |
| [hashCode()](#hashCode--) | Служит хеш‑функцией для конкретного типа. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setValue(int value)](#setValue-int-) | Для описания этого свойства см. [getValue()](../../com.aspose.diagram/selectmode\#getValue--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Для описания этого свойства см. [getValue()](../../com.aspose.diagram/selectmode\#getValue--)
