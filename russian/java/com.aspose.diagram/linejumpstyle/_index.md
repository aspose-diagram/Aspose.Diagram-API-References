...
description: Указывает стиль перехода строки для всех соединителей на странице чертежа, которые не имеют локального стиля перехода строки.
type: docs
weight: 228
url: /ru/java/com.aspose.diagram/linejumpstyle/
---
...
| --- | --- |
| [LineJumpStyle(int value)](#LineJumpStyle-int-) | Конструктор. |
## Методы
...
| [getValue()](#getValue--) | Указывает стиль перехода линии для всех соединителей на чертёжной странице, у которых нет локального стиля перехода линии. |
| [hashCode()](#hashCode--) | Служит хеш‑функцией для конкретного типа. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setValue(int value)](#setValue-int-) | Для описания этого свойства см. [getValue()](../../com.aspose.diagram/linejumpstyle\#getValue--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Для описания этого свойства см. [getValue()](../../com.aspose.diagram/linejumpstyle\#getValue--)
