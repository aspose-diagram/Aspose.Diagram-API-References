...
description: Указывает размер чертежа страницы.
type: docs
weight: 133
url: /ru/java/com.aspose.diagram/drawingsizetype/
---
...
| --- | --- |
| [DrawingSizeType(int value)](#DrawingSizeType-int-) | Конструктор. |
## Методы
...
| [getValue()](#getValue--) | Указывает размер чертежа страницы. |
| [hashCode()](#hashCode--) | Служит хеш‑функцией для конкретного типа. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setValue(int value)](#setValue-int-) | Для описания этого свойства, пожалуйста, см. [getValue()](../../com.aspose.diagram/drawingsizetype\#getValue--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Для описания этого свойства, пожалуйста, см. [getValue()](../../com.aspose.diagram/drawingsizetype\#getValue--)
