...
description: Коллекция ConnectionABCD.
type: docs
weight: 80
url: /ru/java/com.aspose.diagram/connectionabcdcollection/
---
...
Коллекция ConnectionABCD.
## Методы

| Метод | Описание |
| --- | --- |
| [add(ConnectionABCD item)](#add-com.aspose.diagram.ConnectionABCD-) | Добавить объект ConnectionABCD в коллекцию. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(ConnectionABCD item)](#remove-com.aspose.diagram.ConnectionABCD-) | Удалить объект ConnectionABCD из коллекции. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Добавить объект ConnectionABCD в коллекцию.
