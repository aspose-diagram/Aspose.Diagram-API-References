...
type: docs
weight: 71
url: /ru/java/com.aspose.diagram/conlinerouteext/
---
...
| --- | --- |
| [ConLineRouteExt(int value)](#ConLineRouteExt-int-) | Конструктор. |
## Методы
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setValue(int value)](#setValue-int-) | Для описания этого свойства, пожалуйста, см. [getValue()](../../com.aspose.diagram/conlinerouteext\#getValue--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Для описания этого свойства, пожалуйста, см. [getValue()](../../com.aspose.diagram/conlinerouteext\#getValue--)
