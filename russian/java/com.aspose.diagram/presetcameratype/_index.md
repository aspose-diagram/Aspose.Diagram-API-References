...
description: Представляет различные алгоритмические методы установки всех свойств камеры, включая позицию.
type: docs
weight: 296
url: /ru/java/com.aspose.diagram/presetcameratype/
---
...
Представляет различные алгоритмические методы установки всех свойств камеры, включая позицию.
## Поля
