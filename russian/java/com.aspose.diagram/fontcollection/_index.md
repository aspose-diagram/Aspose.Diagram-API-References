...
type: docs
weight: 159
url: /ru/java/com.aspose.diagram/fontcollection/
---
...
| [getFont(int ID)](#getFont-int-) | Получает элемент с указанным ID. |
| [hashCode()](#hashCode--) |  |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| ID | int | intThe ID элемента внутри его родительского элемента. |
