...
type: docs
weight: 369
url: /ru/java/com.aspose.diagram/shapeshdwtype/
---
...
| --- | --- |
| [ShapeShdwType(int value)](#ShapeShdwType-int-) | Конструктор. |
## Методы
...
| [getValue()](#getValue--) | Указывает тип тени для фигуры. |
| [hashCode()](#hashCode--) | Служит хеш‑функцией для конкретного типа. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setValue(int value)](#setValue-int-) | Для описания этого свойства, пожалуйста, смотрите [getValue()](../../com.aspose.diagram/shapeshdwtype\#getValue--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Для описания этого свойства, пожалуйста, смотрите [getValue()](../../com.aspose.diagram/shapeshdwtype\#getValue--)
