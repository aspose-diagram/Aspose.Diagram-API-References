...
type: docs
weight: 39
url: /ru/java/com.aspose.diagram/bullet/
---
...
| --- | --- |
| [Bullet(int value)](#Bullet-int-) | Конструктор. |
## Методы
...
| [getValue()](#getValue--) | Определяет стиль маркера. |
| [hashCode()](#hashCode--) | Служит хеш‑функцией для конкретного типа. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setValue(int value)](#setValue-int-) | Для описания этого свойства, пожалуйста, см. [getValue()](../../com.aspose.diagram/bullet\#getValue--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Для описания этого свойства, пожалуйста, см. [getValue()](../../com.aspose.diagram/bullet\#getValue--)
