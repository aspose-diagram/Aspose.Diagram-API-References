...
description: Содержит коллекцию чисел двойных точек
type: docs
weight: 156
url: /ru/java/com.aspose.diagram/floatpointnumcollection/
---
...
Содержит коллекцию чисел двойных точек
## Конструкторы
...
| Метод | Описание |
| --- | --- |
| [add(double number)](#add-double-) | Добавьте двойное число точки в коллекцию. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(double number)](#remove-double-) | Удалите двойное число точки из коллекции. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Добавьте двойное число точки в коллекцию.
...
Удалите двойное число точки из коллекции.
