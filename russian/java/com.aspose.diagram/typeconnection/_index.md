...
description: Указывает различные типы в зависимости от элемента, в котором он содержится.
type: docs
weight: 413
url: /ru/java/com.aspose.diagram/typeconnection/
---
...
| --- | --- |
| [TypeConnection(int value)](#TypeConnection-int-) | Конструктор. |
## Методы
...
| [getValue()](#getValue--) | Указывает различные типы в зависимости от элемента, в котором он содержится. |
| [hashCode()](#hashCode--) | Служит хеш‑функцией для конкретного типа. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setValue(int value)](#setValue-int-) | Для описания этого свойства, пожалуйста, смотрите [getValue()](../../com.aspose.diagram/typeconnection\#getValue--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Для описания этого свойства, пожалуйста, смотрите [getValue()](../../com.aspose.diagram/typeconnection\#getValue--)
