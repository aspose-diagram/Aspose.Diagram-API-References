...
description: Указывает направление переходов линий на вертикальных динамических соединителях на странице чертежа, для которых не задано локальное направление перехода.
type: docs
weight: 266
url: /ru/java/com.aspose.diagram/pagelinejumpdiry/
---
...
| --- | --- |
| [PageLineJumpDirY(int value)](#PageLineJumpDirY-int-) | Конструктор. |
## Методы
...
| [getValue()](#getValue--) | Указывает направление прыжков линии на вертикальных динамических соединителях на листе чертежа, для которых не задано локальное направление прыжка. |
| [hashCode()](#hashCode--) | Служит хеш‑функцией для конкретного типа. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setValue(int value)](#setValue-int-) | Для описания этого свойства см. [getValue()](../../com.aspose.diagram/pagelinejumpdiry\#getValue--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Для описания этого свойства см. [getValue()](../../com.aspose.diagram/pagelinejumpdiry\#getValue--)
