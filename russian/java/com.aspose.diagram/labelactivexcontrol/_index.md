...
type: docs
weight: 211
url: /ru/java/com.aspose.diagram/labelactivexcontrol/
---
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAccelerator(char value)](#setAccelerator-char-) | Для описания этого свойства, пожалуйста, см. [getAccelerator()](../../com.aspose.diagram/labelactivexcontrol\#getAccelerator--) |
...
| [setBorderOleColor(int value)](#setBorderOleColor-int-) | Для описания этого свойства, пожалуйста, см. [getBorderOleColor()](../../com.aspose.diagram/labelactivexcontrol\#getBorderOleColor--) |
| [setBorderStyle(int value)](#setBorderStyle-int-) | Для описания этого свойства, пожалуйста, см. [getBorderStyle()](../../com.aspose.diagram/labelactivexcontrol\#getBorderStyle--) |
| [setCaption(String value)](#setCaption-java.lang.String-) | Для описания этого свойства, пожалуйста, см. [getCaption()](../../com.aspose.diagram/labelactivexcontrol\#getCaption--) |
...
| [setPicture(byte[] value)](#setPicture-byte---) | Для описания этого свойства, пожалуйста, см. [getPicture()](../../com.aspose.diagram/labelactivexcontrol\#getPicture--) |
| [setPicturePosition(int value)](#setPicturePosition-int-) | Для описания этого свойства, пожалуйста, см. [getPicturePosition()](../../com.aspose.diagram/labelactivexcontrol\#getPicturePosition--) |
| [setSpecialEffect(int value)](#setSpecialEffect-int-) | Для описания этого свойства, пожалуйста, см. [getSpecialEffect()](../../com.aspose.diagram/labelactivexcontrol\#getSpecialEffect--) |
...
| [setWordWrapped(boolean value)](#setWordWrapped-boolean-) | Для описания этого свойства, пожалуйста, см. [isWordWrapped()](../../com.aspose.diagram/labelactivexcontrol\#isWordWrapped--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Для описания этого свойства, пожалуйста, см. [getAccelerator()](../../com.aspose.diagram/labelactivexcontrol\#getAccelerator--)
...
Для описания этого свойства, пожалуйста, см. [getBorderOleColor()](../../com.aspose.diagram/labelactivexcontrol\#getBorderOleColor--)
...
Для описания этого свойства, пожалуйста, см. [getBorderStyle()](../../com.aspose.diagram/labelactivexcontrol\#getBorderStyle--)
...
Для описания этого свойства, пожалуйста, см. [getCaption()](../../com.aspose.diagram/labelactivexcontrol\#getCaption--)
...
Для описания этого свойства, пожалуйста, см. [getPicture()](../../com.aspose.diagram/labelactivexcontrol\#getPicture--)
...
Для описания этого свойства, пожалуйста, см. [getPicturePosition()](../../com.aspose.diagram/labelactivexcontrol\#getPicturePosition--)
...
Для описания этого свойства, пожалуйста, см. [getSpecialEffect()](../../com.aspose.diagram/labelactivexcontrol\#getSpecialEffect--)
...
Для описания этого свойства, пожалуйста, см. [isWordWrapped()](../../com.aspose.diagram/labelactivexcontrol\#isWordWrapped--)
