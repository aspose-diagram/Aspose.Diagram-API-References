...
description: Указывает поведение размещения для размещаемой фигуры.
type: docs
weight: 357
url: /ru/java/com.aspose.diagram/shapefixedcode/
---
...
| --- | --- |
| [ShapeFixedCode(int value)](#ShapeFixedCode-int-) | Конструктор. |
## Методы
...
| [getValue()](#getValue--) | Указывает поведение размещения для размещаемой фигуры. |
| [hashCode()](#hashCode--) | Служит хеш‑функцией для конкретного типа. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setValue(int value)](#setValue-int-) | Для описания этого свойства см. [getValue()](../../com.aspose.diagram/shapefixedcode\#getValue--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Для описания этого свойства см. [getValue()](../../com.aspose.diagram/shapefixedcode\#getValue--)
