...
description: Указывает внешний вид по умолчанию для всех соединителей на странице.
type: docs
weight: 230
url: /ru/java/com.aspose.diagram/linerouteext/
---
...
| --- | --- |
| [LineRouteExt(int value)](#LineRouteExt-int-) | Конструктор. |
## Методы
...
| [getValue()](#getValue--) | Указывает внешний вид по умолчанию для всех соединителей на странице. |
| [hashCode()](#hashCode--) | Служит хеш‑функцией для конкретного типа. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setValue(int value)](#setValue-int-) | Для описания этого свойства, пожалуйста, см. [getValue()](../../com.aspose.diagram/linerouteext\#getValue--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Для описания этого свойства, пожалуйста, см. [getValue()](../../com.aspose.diagram/linerouteext\#getValue--)
