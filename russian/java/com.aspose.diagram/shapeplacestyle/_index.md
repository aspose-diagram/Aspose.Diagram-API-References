...
description: Определяет стиль размещения для дочерних элементов.
type: docs
weight: 361
url: /ru/java/com.aspose.diagram/shapeplacestyle/
---
...
| --- | --- |
| [ShapePlaceStyle(int value)](#ShapePlaceStyle-int-) | Конструктор. |
## Методы
...
| [getValue()](#getValue--) | Определяет внешний вид соединителя. |
| [hashCode()](#hashCode--) | Служит хеш‑функцией для конкретного типа. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setValue(int value)](#setValue-int-) | Для описания этого свойства см. [getValue()](../../com.aspose.diagram/shapeplacestyle\#getValue--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Для описания этого свойства см. [getValue()](../../com.aspose.diagram/shapeplacestyle\#getValue--)
