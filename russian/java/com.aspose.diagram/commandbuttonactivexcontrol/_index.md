...
description: Представляет кнопку команды.
type: docs
weight: 56
url: /ru/java/com.aspose.diagram/commandbuttonactivexcontrol/
---
...
| [getTakeFocusOnClick()](#getTakeFocusOnClick--) | Указывает, получает ли элемент управления фокус при щелчке. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAccelerator(char value)](#setAccelerator-char-) | Для описания этого свойства см. [getAccelerator()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getAccelerator--) |
...
| [setCaption(String value)](#setCaption-java.lang.String-) | Для описания этого свойства см. [getCaption()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getCaption--) |
...
| [setPicture(byte[] value)](#setPicture-byte---) | Для описания этого свойства см. [getPicture()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getPicture--) |
| [setPicturePosition(int value)](#setPicturePosition-int-) | Для описания этого свойства см. [getPicturePosition()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getPicturePosition--) |
| [setTakeFocusOnClick(boolean value)](#setTakeFocusOnClick-boolean-) | Для описания этого свойства см. [getTakeFocusOnClick()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getTakeFocusOnClick--) |
...
| [setWordWrapped(boolean value)](#setWordWrapped-boolean-) | Для описания этого свойства см. [isWordWrapped()](../../com.aspose.diagram/commandbuttonactivexcontrol\#isWordWrapped--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Указывает, получает ли элемент управления фокус при щелчке.
...
Для описания этого свойства см. [getAccelerator()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getAccelerator--)
...
Для описания этого свойства см. [getCaption()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getCaption--)
...
Для описания этого свойства см. [getPicture()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getPicture--)
...
Для описания этого свойства см. [getPicturePosition()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getPicturePosition--)
...
Для описания этого свойства см. [getTakeFocusOnClick()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getTakeFocusOnClick--)
...
Для описания этого свойства см. [isWordWrapped()](../../com.aspose.diagram/commandbuttonactivexcontrol\#isWordWrapped--)
