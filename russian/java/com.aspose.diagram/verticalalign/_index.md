...
description: Указывает вертикальное выравнивание текста внутри текстового блока.
type: docs
weight: 437
url: /ru/java/com.aspose.diagram/verticalalign/
---
...
| --- | --- |
| [VerticalAlign(int value)](#VerticalAlign-int-) | Конструктор. |
## Методы
...
| [getValue()](#getValue--) | Указывает вертикальное выравнивание текста внутри текстового блока. |
| [hashCode()](#hashCode--) | Служит хеш‑функцией для конкретного типа. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setUfe(UnitFormulaErr value)](#setUfe-com.aspose.diagram.UnitFormulaErr-) | Для описания этого свойства, пожалуйста, см. [getUfe()](../../com.aspose.diagram/verticalalign\#getUfe--) |
| [setValue(int value)](#setValue-int-) | Для описания этого свойства, пожалуйста, см. [getValue()](../../com.aspose.diagram/verticalalign\#getValue--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Для описания этого свойства, пожалуйста, см. [getUfe()](../../com.aspose.diagram/verticalalign\#getUfe--)
...
Для описания этого свойства, пожалуйста, см. [getValue()](../../com.aspose.diagram/verticalalign\#getValue--)
