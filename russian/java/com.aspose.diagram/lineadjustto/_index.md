...
description: Указывает, какие динамические соединители выравнивать друг над другом, если они маршрутизируются друг над другом.
type: docs
weight: 224
url: /ru/java/com.aspose.diagram/lineadjustto/
---
...
| --- | --- |
| [LineAdjustTo(int value)](#LineAdjustTo-int-) | Конструктор. |
## Методы
...
| [getValue()](#getValue--) | Указывает, какие динамические соединители выравнивать друг над другом, если они маршрутизируются друг над другом. |
| [hashCode()](#hashCode--) | Служит хеш‑функцией для конкретного типа. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setValue(int value)](#setValue-int-) | Для описания этого свойства, пожалуйста, смотрите [getValue()](../../com.aspose.diagram/lineadjustto\#getValue--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Для описания этого свойства, пожалуйста, смотрите [getValue()](../../com.aspose.diagram/lineadjustto\#getValue--)
