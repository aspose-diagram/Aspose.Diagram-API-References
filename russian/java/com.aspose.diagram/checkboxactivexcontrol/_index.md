...
description: Представляет элемент управления CheckBox ActiveX.
type: docs
weight: 47
url: /ru/java/com.aspose.diagram/checkboxactivexcontrol/
---
...
Представляет элемент управления CheckBox ActiveX.
## Методы

| Метод | Описание |
| --- | --- |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getAccelerator()](#getAccelerator--) | клавиша ускорителя для элемента управления. |
| [getAlignment()](#getAlignment--) | позиция подписи (Caption) относительно элемента управления. |
| [getBackOleColor()](#getBackOleColor--) | the ole color of the background. |
| [getCaption()](#getCaption--) | описательный текст, отображаемый на элементе управления. |
| [getClass()](#getClass--) |  |
| [getData()](#getData--) | the binary data of the control. |
| [getForeOleColor()](#getForeOleColor--) | the ole color of the foreground. |
| [getGroupName()](#getGroupName--) | имя группы. |
...
| [getPicturePosition()](#getPicturePosition--) | расположение изображения элемента управления относительно его подписи. |
...
| [getValue()](#getValue--) | Указывает, отмечен элемент управления или нет. |
...
| [isChecked()](#isChecked--) | Указывает, отмечен ли флажок. |
...
| [isTripleState()](#isTripleState--) | Указывает, как указанный элемент управления будет отображать значения Null. |
| [isWordWrapped()](#isWordWrapped--) | Указывает, будет ли содержимое элемента управления автоматически переноситься в конце строки. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAccelerator(char value)](#setAccelerator-char-) | Для описания этого свойства, пожалуйста, см. [getAccelerator()](../../com.aspose.diagram/checkboxactivexcontrol\#getAccelerator--) |
| [setAlignment(int value)](#setAlignment-int-) | Для описания этого свойства, пожалуйста, см. [getAlignment()](../../com.aspose.diagram/checkboxactivexcontrol\#getAlignment--) |
...
| [setCaption(String value)](#setCaption-java.lang.String-) | Для описания этого свойства, пожалуйста, см. [getCaption()](../../com.aspose.diagram/checkboxactivexcontrol\#getCaption--) |
| [setChecked(boolean value)](#setChecked-boolean-) | Для описания этого свойства, пожалуйста, см. [isChecked()](../../com.aspose.diagram/checkboxactivexcontrol\#isChecked--) |
...
| [setGroupName(String value)](#setGroupName-java.lang.String-) | Для описания этого свойства, пожалуйста, см. [getGroupName()](../../com.aspose.diagram/checkboxactivexcontrol\#getGroupName--) |
...
| [setPicture(byte[] value)](#setPicture-byte---) | Для описания этого свойства, пожалуйста, см. [getPicture()](../../com.aspose.diagram/checkboxactivexcontrol\#getPicture--) |
| [setPicturePosition(int value)](#setPicturePosition-int-) | Для описания этого свойства, пожалуйста, см. [getPicturePosition()](../../com.aspose.diagram/checkboxactivexcontrol\#getPicturePosition--) |
| [setSpecialEffect(int value)](#setSpecialEffect-int-) | Для описания этого свойства, пожалуйста, см. [getSpecialEffect()](../../com.aspose.diagram/checkboxactivexcontrol\#getSpecialEffect--) |
...
| [setTripleState(boolean value)](#setTripleState-boolean-) | Для описания этого свойства, пожалуйста, см. [isTripleState()](../../com.aspose.diagram/checkboxactivexcontrol\#isTripleState--) |
| [setValue(int value)](#setValue-int-) | Для описания этого свойства, пожалуйста, см. [getValue()](../../com.aspose.diagram/checkboxactivexcontrol\#getValue--) |
...
| [setWordWrapped(boolean value)](#setWordWrapped-boolean-) | Для описания этого свойства, пожалуйста, см. [isWordWrapped()](../../com.aspose.diagram/checkboxactivexcontrol\#isWordWrapped--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
клавиша ускорителя для элемента управления.
...
позиция подписи (Caption) относительно элемента управления.
...
описательный текст, отображаемый на элементе управления.
...
расположение изображения элемента управления относительно его подписи.
...
Указывает, отмечен элемент управления или нет.
...
| ------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| Setting | Description                                                                                                                                     |
| True    | Элемент управления будет переключаться между состояниями Да, Нет и Null. Элемент управления отображается затемнённым (серым), когда его свойство Value установлено в Null. |
| False   | (Default) Элемент управления будет переключаться между состояниями Да и Нет. Значения Null отображаются как значения Нет.                           |
...
Для описания этого свойства, пожалуйста, см. [getAccelerator()](../../com.aspose.diagram/checkboxactivexcontrol\#getAccelerator--)
...
Для описания этого свойства, пожалуйста, см. [getAlignment()](../../com.aspose.diagram/checkboxactivexcontrol\#getAlignment--)
...
Для описания этого свойства, пожалуйста, см. [getCaption()](../../com.aspose.diagram/checkboxactivexcontrol\#getCaption--)
...
Для описания этого свойства, пожалуйста, см. [isChecked()](../../com.aspose.diagram/checkboxactivexcontrol\#isChecked--)
...
Для описания этого свойства, пожалуйста, см. [getGroupName()](../../com.aspose.diagram/checkboxactivexcontrol\#getGroupName--)
...
Для описания этого свойства, пожалуйста, см. [getPicture()](../../com.aspose.diagram/checkboxactivexcontrol\#getPicture--)
...
Для описания этого свойства, пожалуйста, см. [getPicturePosition()](../../com.aspose.diagram/checkboxactivexcontrol\#getPicturePosition--)
...
Для описания этого свойства, пожалуйста, см. [getSpecialEffect()](../../com.aspose.diagram/checkboxactivexcontrol\#getSpecialEffect--)
...
Для описания этого свойства, пожалуйста, см. [isTripleState()](../../com.aspose.diagram/checkboxactivexcontrol\#isTripleState--)
...
Для описания этого свойства, пожалуйста, см. [getValue()](../../com.aspose.diagram/checkboxactivexcontrol\#getValue--)
...
Для описания этого свойства, пожалуйста, см. [isWordWrapped()](../../com.aspose.diagram/checkboxactivexcontrol\#isWordWrapped--)
