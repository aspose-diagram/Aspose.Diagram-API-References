...
description: Используется для установки свойства темы стиля Shape.
type: docs
weight: 300
url: /ru/java/com.aspose.diagram/presetstylematricsvalue/
---
...
Используется для установки свойства темы стиля Shape.
## Поля
