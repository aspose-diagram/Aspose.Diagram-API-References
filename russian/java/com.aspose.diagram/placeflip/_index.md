...
description: Указывает, как размещаемые фигуры отражаются и/или вращаются на странице, когда фигуры размещаются с помощью команды "Lay Out Shapes" в Microsoft Visio.
type: docs
weight: 287
url: /ru/java/com.aspose.diagram/placeflip/
---
...
| --- | --- |
| [PlaceFlip(int value)](#PlaceFlip-int-) | Конструктор. |
## Методы
...
| [getValue()](#getValue--) | Указывает, как размещаемые фигуры отражаются и/или вращаются на странице, когда фигуры размещаются с помощью команды "Lay Out Shapes" в Microsoft Visio. |
