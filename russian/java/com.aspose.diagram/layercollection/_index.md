...
description: Коллекция Layer.
type: docs
weight: 213
url: /ru/java/com.aspose.diagram/layercollection/
---
...
| Метод | Описание |
| --- | --- |
| [add(Layer item)](#add-com.aspose.diagram.Layer-) | Добавьте объект Layer в коллекцию. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Layer item)](#remove-com.aspose.diagram.Layer-) | Удалите объект Layer из коллекции. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Удалите объект Layer из коллекции.
