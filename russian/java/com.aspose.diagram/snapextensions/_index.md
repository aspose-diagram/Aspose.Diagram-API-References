...
description: Указывает, включена ли конкретная настройка расширения привязки для активного окна.
type: docs
weight: 377
url: /ru/java/com.aspose.diagram/snapextensions/
---
...
Указывает, включена ли конкретная настройка snap‑extension для активного окна или отключена. Значение может быть суммой значений.
## Поля
