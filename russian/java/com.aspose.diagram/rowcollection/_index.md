...
description: Коллекция Row.
type: docs
weight: 337
url: /ru/java/com.aspose.diagram/rowcollection/
---
...
| Метод | Описание |
| --- | --- |
| [add(Row row)](#add-com.aspose.diagram.Row-) | Добавить строку в коллекцию. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Row row)](#remove-com.aspose.diagram.Row-) | Удалить строку из коллекции. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
