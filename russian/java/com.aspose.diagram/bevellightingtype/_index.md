...
type: docs
weight: 31
url: /ru/java/com.aspose.diagram/bevellightingtype/
---
...
| --- | --- |
| [BevelLightingType(int value)](#BevelLightingType-int-) | Конструктор. |
## Методы
...
| [getValue()](#getValue--) | Указывает тип фаски. |
| [hashCode()](#hashCode--) | Служит хеш‑функцией для конкретного типа. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setValue(int value)](#setValue-int-) | Для описания этого свойства, пожалуйста, смотрите [getValue()](../../com.aspose.diagram/bevellightingtype\#getValue--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Для описания этого свойства, пожалуйста, смотрите [getValue()](../../com.aspose.diagram/bevellightingtype\#getValue--)
