...
description: يحدد اتجاه الأحرف في كتلة النص.
type: docs
weight: 403
url: /ar/java/com.aspose.diagram/textdirection/
---
...
| منشئ | الوصف |
| --- | --- |
| [TextDirection(int value)](#TextDirection-int-) | منشئ. |
## الطرق
...
| [getValue()](#getValue--) | يحدد اتجاه الأحرف في كتلة النص. |
