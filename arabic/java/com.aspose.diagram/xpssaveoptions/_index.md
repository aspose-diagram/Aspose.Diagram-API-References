...
description: يسمح بتحديد خيارات إضافية عند تصيير صفحات المخطط إلى XPS.
type: docs
weight: 453
url: /ar/java/com.aspose.diagram/xpssaveoptions/
---
...
يسمح بتحديد خيارات إضافية عند تصيير صفحات المخطط إلى XPS.
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [XPSSaveOptions()](#XPSSaveOptions--) | يُنشئ مثيلاً جديدًا من هذه الفئة يمكن استخدامه لحفظ مستند بتنسيق Aspose.Diagram.SaveFileFormat. |
## الطرق
...
| [getPageCount()](#getPageCount--) | عدد الصفحات التي سيتم عرضها في XPS. |
...
| [setExportHiddenPage(boolean value)](#setExportHiddenPage-boolean-) | للحصول على وصف هذه الخاصية، يرجى الاطلاع على [getExportHiddenPage()](../../com.aspose.diagram/xpssaveoptions\#getExportHiddenPage--) |
| [setPageCount(int value)](#setPageCount-int-) | للحصول على وصف هذه الخاصية، يرجى الاطلاع على [getPageCount()](../../com.aspose.diagram/xpssaveoptions\#getPageCount--) |
| [setPageIndex(int value)](#setPageIndex-int-) | للحصول على وصف هذه الخاصية، يرجى الاطلاع على [getPageIndex()](../../com.aspose.diagram/xpssaveoptions\#getPageIndex--) |
| [setSaveForegroundPagesOnly(boolean value)](#setSaveForegroundPagesOnly-boolean-) | للحصول على وصف هذه الخاصية، يرجى الاطلاع على [getSaveForegroundPagesOnly()](../../com.aspose.diagram/xpssaveoptions\#getSaveForegroundPagesOnly--) |
| [setSaveFormat(int value)](#setSaveFormat-int-) | للحصول على وصف هذه الخاصية، يرجى الاطلاع على [getSaveFormat()](../../com.aspose.diagram/xpssaveoptions\#getSaveFormat--) |
...
عدد الصفحات التي سيتم عرضها في XPS. الافتراضي هو MaxValue مما يعني أنه سيتم عرض جميع صفحات المخطط.
...
للحصول على وصف هذه الخاصية، يرجى الاطلاع على [getExportHiddenPage()](../../com.aspose.diagram/xpssaveoptions\#getExportHiddenPage--)
...
للحصول على وصف هذه الخاصية، يرجى الاطلاع على [getPageCount()](../../com.aspose.diagram/xpssaveoptions\#getPageCount--)
...
للحصول على وصف هذه الخاصية، يرجى الاطلاع على [getPageIndex()](../../com.aspose.diagram/xpssaveoptions\#getPageIndex--)
...
للحصول على وصف هذه الخاصية، يرجى الاطلاع على [getSaveForegroundPagesOnly()](../../com.aspose.diagram/xpssaveoptions\#getSaveForegroundPagesOnly--)
...
للحصول على وصف هذه الخاصية، يرجى الاطلاع على [getSaveFormat()](../../com.aspose.diagram/xpssaveoptions\#getSaveFormat--)
