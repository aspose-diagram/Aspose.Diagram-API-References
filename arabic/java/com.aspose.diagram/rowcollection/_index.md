...
description: مجموعة الصفوف.
type: docs
weight: 337
url: /ar/java/com.aspose.diagram/rowcollection/
---
...
| طريقة | الوصف |
| --- | --- |
| [add(Row row)](#add-com.aspose.diagram.Row-) | أضف الصف إلى المجموعة. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Row row)](#remove-com.aspose.diagram.Row-) | أزل الصف من المجموعة. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
