...
description: مجموعة Annotation.
type: docs
weight: 21
url: /ar/java/com.aspose.diagram/annotationcollection/
---
...
| طريقة | الوصف |
| --- | --- |
| [add(Annotation item)](#add-com.aspose.diagram.Annotation-) | أضف كائن Annotation إلى المجموعة. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Annotation item)](#remove-com.aspose.diagram.Annotation-) | أزل كائن Annotation من المجموعة. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
أضف كائن Annotation إلى المجموعة.
...
أزل كائن Annotation من المجموعة.
