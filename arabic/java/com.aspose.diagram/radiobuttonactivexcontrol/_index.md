...
type: docs
weight: 313
url: /ar/java/com.aspose.diagram/radiobuttonactivexcontrol/
---
...
| [getAlignment()](#getAlignment--) | موضع التسمية (Caption) بالنسبة للعنصر. |
...
| [getGroupName()](#getGroupName--) | اسم المجموعة. |
...
| [getValue()](#getValue--) | يشير إلى ما إذا كان التحكم محددًا أم لا. |
...
| [isTripleState()](#isTripleState--) | يشير إلى كيفية عرض القيم الفارغة (Null) بواسطة التحكم المحدد. |
| [isWordWrapped()](#isWordWrapped--) | يشير إلى ما إذا كان محتوى التحكم يلتف تلقائيًا في نهاية السطر. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAccelerator(char value)](#setAccelerator-char-) | لوصف هذه الخاصية، يرجى الاطلاع على [getAccelerator()](../../com.aspose.diagram/togglebuttonactivexcontrol\#getAccelerator--) |
| [setAlignment(int value)](#setAlignment-int-) | لوصف هذه الخاصية، يرجى الاطلاع على [getAlignment()](../../com.aspose.diagram/radiobuttonactivexcontrol\#getAlignment--) |
...
| [setCaption(String value)](#setCaption-java.lang.String-) | لوصف هذه الخاصية، يرجى الاطلاع على [getCaption()](../../com.aspose.diagram/togglebuttonactivexcontrol\#getCaption--) |
...
| [setGroupName(String value)](#setGroupName-java.lang.String-) | لوصف هذه الخاصية، يرجى الاطلاع على [getGroupName()](../../com.aspose.diagram/radiobuttonactivexcontrol\#getGroupName--) |
...
| [setPicture(byte[] value)](#setPicture-byte---) | لوصف هذه الخاصية، يرجى الاطلاع على [getPicture()](../../com.aspose.diagram/togglebuttonactivexcontrol\#getPicture--) |
| [setPicturePosition(int value)](#setPicturePosition-int-) | لوصف هذه الخاصية، يرجى الاطلاع على [getPicturePosition()](../../com.aspose.diagram/togglebuttonactivexcontrol\#getPicturePosition--) |
| [setSpecialEffect(int value)](#setSpecialEffect-int-) | لوصف هذه الخاصية، يرجى الاطلاع على [getSpecialEffect()](../../com.aspose.diagram/togglebuttonactivexcontrol\#getSpecialEffect--) |
...
| [setTripleState(boolean value)](#setTripleState-boolean-) | لوصف هذه الخاصية، يرجى الاطلاع على [isTripleState()](../../com.aspose.diagram/togglebuttonactivexcontrol\#isTripleState--) |
| [setValue(int value)](#setValue-int-) | لوصف هذه الخاصية، يرجى الاطلاع على [getValue()](../../com.aspose.diagram/togglebuttonactivexcontrol\#getValue--) |
...
| [setWordWrapped(boolean value)](#setWordWrapped-boolean-) | لوصف هذه الخاصية، يرجى الاطلاع على [isWordWrapped()](../../com.aspose.diagram/radiobuttonactivexcontrol\#isWordWrapped--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
موضع التسمية (Caption) بالنسبة للعنصر.
...
يشير إلى ما إذا كان التحكم محددًا أم لا.
...
يشير إلى كيفية عرض القيم الفارغة (Null) بواسطة التحكم المحدد.

| ------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| الإعداد | الوصف                                                                                                                                     |
| True    | سيقوم التحكم بالدوران عبر الحالات للقيم نعم، لا، والقيم الفارغة (Null). يظهر التحكم باهتًا (رماديًا) عندما يتم تعيين خاصية Value إلى Null. |
| False   | (افتراضي) سيقوم التحكم بالدوران عبر الحالات للقيم نعم ولا. تُعرض القيم الفارغة كما لو كانت قيم لا.                           |
...
لوصف هذه الخاصية، يرجى الاطلاع على [getAccelerator()](../../com.aspose.diagram/togglebuttonactivexcontrol\#getAccelerator--)
...
لوصف هذه الخاصية، يرجى الاطلاع على [getAlignment()](../../com.aspose.diagram/radiobuttonactivexcontrol\#getAlignment--)
...
لوصف هذه الخاصية، يرجى الاطلاع على [getCaption()](../../com.aspose.diagram/togglebuttonactivexcontrol\#getCaption--)
...
لوصف هذه الخاصية، يرجى الاطلاع على [getGroupName()](../../com.aspose.diagram/radiobuttonactivexcontrol\#getGroupName--)
...
لوصف هذه الخاصية، يرجى الاطلاع على [getPicture()](../../com.aspose.diagram/togglebuttonactivexcontrol\#getPicture--)
...
لوصف هذه الخاصية، يرجى الاطلاع على [getPicturePosition()](../../com.aspose.diagram/togglebuttonactivexcontrol\#getPicturePosition--)
...
لوصف هذه الخاصية، يرجى الاطلاع على [getSpecialEffect()](../../com.aspose.diagram/togglebuttonactivexcontrol\#getSpecialEffect--)
...
لوصف هذه الخاصية، يرجى الاطلاع على [isTripleState()](../../com.aspose.diagram/togglebuttonactivexcontrol\#isTripleState--)
...
لوصف هذه الخاصية، يرجى الاطلاع على [getValue()](../../com.aspose.diagram/togglebuttonactivexcontrol\#getValue--)
...
لوصف هذه الخاصية، يرجى الاطلاع على [isWordWrapped()](../../com.aspose.diagram/radiobuttonactivexcontrol\#isWordWrapped--)
