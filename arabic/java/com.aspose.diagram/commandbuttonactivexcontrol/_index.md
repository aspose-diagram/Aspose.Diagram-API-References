...
type: docs
weight: 56
url: /ar/java/com.aspose.diagram/commandbuttonactivexcontrol/
---
...
| [getTakeFocusOnClick()](#getTakeFocusOnClick--) | يشير إلى ما إذا كان التحكم يحصل على التركيز عند النقر. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAccelerator(char value)](#setAccelerator-char-) | لوصف هذه الخاصية، يرجى الاطلاع على [getAccelerator()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getAccelerator--) |
...
| [setCaption(String value)](#setCaption-java.lang.String-) | لوصف هذه الخاصية، يرجى الاطلاع على [getCaption()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getCaption--) |
...
| [setPicture(byte[] value)](#setPicture-byte---) | لوصف هذه الخاصية، يرجى الاطلاع على [getPicture()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getPicture--) |
| [setPicturePosition(int value)](#setPicturePosition-int-) | لوصف هذه الخاصية، يرجى الاطلاع على [getPicturePosition()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getPicturePosition--) |
| [setTakeFocusOnClick(boolean value)](#setTakeFocusOnClick-boolean-) | لوصف هذه الخاصية، يرجى الاطلاع على [getTakeFocusOnClick()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getTakeFocusOnClick--) |
...
| [setWordWrapped(boolean value)](#setWordWrapped-boolean-) | لوصف هذه الخاصية، يرجى الاطلاع على [isWordWrapped()](../../com.aspose.diagram/commandbuttonactivexcontrol\#isWordWrapped--) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
يشير إلى ما إذا كان التحكم يحصل على التركيز عند النقر.
...
لوصف هذه الخاصية، يرجى الاطلاع على [getAccelerator()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getAccelerator--)
...
لوصف هذه الخاصية، يرجى الاطلاع على [getCaption()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getCaption--)
...
لوصف هذه الخاصية، يرجى الاطلاع على [getPicture()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getPicture--)
...
لوصف هذه الخاصية، يرجى الاطلاع على [getPicturePosition()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getPicturePosition--)
...
لوصف هذه الخاصية، يرجى الاطلاع على [getTakeFocusOnClick()](../../com.aspose.diagram/commandbuttonactivexcontrol\#getTakeFocusOnClick--)
...
لوصف هذه الخاصية، يرجى الاطلاع على [isWordWrapped()](../../com.aspose.diagram/commandbuttonactivexcontrol\#isWordWrapped--)
