...
type: docs
weight: 424
url: /ar/java/com.aspose.diagram/unknowncontrol/
---
...
| [getPersistenceType()](#getPersistenceType--) | يحصل على طريقة الاستمرارية لحفظ عنصر تحكم ActiveX. |
| [getRelationshipData(String relId)](#getRelationshipData-java.lang.String-) | يحصل على بيانات العلاقة. |
...
يحصل على طريقة الاستمرارية لحفظ عنصر تحكم ActiveX.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| relId | java.lang.String | معرف العلاقة. |

**Returns:**
byte[] - يُرجِع بيانات العلاقة.
### getType() {#getType--}
```
public int getType()
```
