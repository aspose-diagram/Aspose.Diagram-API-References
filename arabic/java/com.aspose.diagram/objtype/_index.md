...
type: docs
weight: 252
url: /ar/java/com.aspose.diagram/objtype/
---
...
| منشئ | الوصف |
| --- | --- |
| [ObjType(int value)](#ObjType-int-) | منشئ. |
## الطرق
...
| [getValue()](#getValue--) | يحدد ما إذا كان يمكن وضع الكائنات أو توجيهها في المخططات عند استخدام Microsoft Visio لترتيب الأشكال على صفحة الرسم. |
