...
description: يحدد خوارزمية التجزئة الرقمية المستخدمة في التوقيع الرقمي.
type: docs
weight: 277
url: /ar/java/com.aspose.diagram/pdfdigitalsignaturehashalgorithm/
---
...
| حقل | الوصف |
| --- | --- |
| [MD_5](#MD-5) | خوارزمية تجزئة SHA-1. |
| [SHA_1](#SHA-1) | خوارزمية تجزئة SHA-1. |
