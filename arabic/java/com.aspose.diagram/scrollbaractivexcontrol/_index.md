...
description: يمثل عنصر التحكم ScrollBar.
type: docs
weight: 352
url: /ar/java/com.aspose.diagram/scrollbaractivexcontrol/
---
...
| [getLargeChange()](#getLargeChange--) | المقدار الذي تتغيّر به خاصية Position |
...
| [setLargeChange(int value)](#setLargeChange-int-) | للحصول على وصف هذه الخاصية، يرجى الاطلاع على [getLargeChange()](../../com.aspose.diagram/scrollbaractivexcontrol\#getLargeChange--) |
...
للحصول على وصف هذه الخاصية، يرجى الاطلاع على [getLargeChange()](../../com.aspose.diagram/scrollbaractivexcontrol\#getLargeChange--)
