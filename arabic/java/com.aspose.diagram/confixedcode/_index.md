...
description: يحدد متى يعيد الموصل توجيه نفسه.
type: docs
weight: 61
url: /ar/java/com.aspose.diagram/confixedcode/
---
...
| منشئ | الوصف |
| --- | --- |
| [ConFixedCode(int value)](#ConFixedCode-int-) | منشئ. |
## الطرق
...
| [getValue()](#getValue--) | يحدد متى يعيد الموصل توجيه نفسه. |
