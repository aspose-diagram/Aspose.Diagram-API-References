...
description: يمثل مجموعة نقاط توقف التدرج.
type: docs
weight: 182
url: /ar/java/com.aspose.diagram/gradientstopcollection/
---
...
يمثل مجموعة نقاط توقف التدرج.
## الطرق

| طريقة | الوصف |
| --- | --- |
| [add(DoubleValue position, ColorValue color)](#add-com.aspose.diagram.DoubleValue-com.aspose.diagram.ColorValue-) | أضف نقطة توقف تدرج. |
| [clear()](#clear--) | يزيل جميع العناصر من المجموعة. |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [get(int index)](#get-int-) | يحصل على نقطة توقف التدرج حسب الفهرس. |
| [getClass()](#getClass--) |  |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| position | [DoubleValue](../../com.aspose.diagram/doublevalue) | موضع نقطة التوقف، بوحدة النسبة المئوية. |
| color | [ColorValue](../../com.aspose.diagram/colorvalue) | لون نقطة التوقف. |
...
يحصل على نقطة توقف التدرج حسب الفهرس.
