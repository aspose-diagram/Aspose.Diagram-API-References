...
type: docs
weight: 402
url: /ar/java/com.aspose.diagram/textcollection/
---
...
يحتوي على نص شكل. كل عنصر هو نص مع خصائص الحرف والفقرة والمسافات.
## الطرق

| طريقة | الوصف |
| --- | --- |
| [add(Text item)](#add-com.aspose.diagram.Text-) | أضف كائن Text إلى المجموعة. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Text item)](#remove-com.aspose.diagram.Text-) | أزل كائن Text من المجموعة. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
