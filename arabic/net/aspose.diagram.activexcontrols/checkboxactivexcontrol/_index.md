...
description: يمثل عنصر تحكم ActiveX الخاص بـ CheckBox.
type: docs
weight: 70
url: /ar/net/aspose.diagram.activexcontrols/checkboxactivexcontrol/
---
## CheckBoxActiveXControl class

يمثل عنصر تحكم ActiveX الخاص بـ CheckBox.
...
| اسم | وصف |
| --- | --- |
| [Accelerator](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/accelerator/) { get; set; } | الحصول على مفتاح التسريع لعنصر التحكم وتعيينه. |
| [Alignment](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/alignment/) { get; set; } | الحصول على وتعيين موضع التسمية التوضيحية بالنسبة لعنصر التحكم. |
| [BackOleColor](../../aspose.diagram.activexcontrols/activexcontrolbase/backolecolor/) { get; set; } | الحصول على لون أول للخلفية وتعيينه. |
| [Caption](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/caption/) { get; set; } | الحصول على النص الوصفي الذي يظهر في عنصر التحكم وتعيينه. |
...
| [GroupName](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/groupname/) { get; set; } | الحصول على اسم المجموعة وتعيينه . |
...
| [IsChecked](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/ischecked/) { get; set; } | يشير إلى ما إذا كان المربع محددًا أم لا. |
...
| [IsTripleState](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/istriplestate/) { get; set; } | يشير إلى الكيفية التي سيعرض بها عنصر التحكم المحدد القيم الخالية. |
| [IsWordWrapped](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/iswordwrapped/) { get; set; } | يشير إلى ما إذا كانت محتويات عنصر التحكم تلتف تلقائيًا في نهاية السطر. |
...
| [Picture](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/picture/) { get; set; } | الحصول على بيانات الصورة وتعيينها. |
| [PicturePosition](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/pictureposition/) { get; set; } | الحصول على وتعيين موقع صورة عنصر التحكم بالنسبة إلى التسمية التوضيحية الخاصة بها. |
| [SpecialEffect](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/specialeffect/) { get; set; } | الحصول على التأثير الخاص لعنصر التحكم وتعيينه. |
| override [Type](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/type/) { get; } | يحصل على نوع عنصر تحكم ActiveX. |
| [Value](../../aspose.diagram.activexcontrols/checkboxactivexcontrol/value/) { get; set; } | يشير إلى ما إذا كان عنصر التحكم محددًا أم لا. |
