...
| [ViewerIncluded](../../aspose.diagram.saving/swfsaveoptions/viewerincluded) { get; set; } | Gibt an, ob das generierte SWF-Dokument den integrierten Dokumentbetrachter enthalten soll oder nicht. Der Standardwert ist`Stimmt`. |
